...
### [1] [Transient Thermodynamic Efficiency of Adaptive Inference in Continuously Nonstationary Environments](https://arxiv.org/abs/2603.19324)
*Aditya Gupta*
...
### [2] [Logarithmic growth of operator entanglement in a clean non-integrable circuit](https://arxiv.org/abs/2603.19363)
...
### [3] [Dynamic scaling near the Kasteleyn transition in spin ice: critical relaxation of monopoles and strings following a field quench](https://arxiv.org/abs/2603.19408)
...
### [4] [Level 2.5 large deviations and uncertainty relations for self-interacting jump processes: tilting constructions and the emergence of time-scale separation](https://arxiv.org/abs/2603.19411)
...
### [5] [Sorting by Resetting](https://arxiv.org/abs/2603.19430)
...
### [6] [Starvation suppression in scale-free metabolic networks: Dynamical mean-field analysis of dense catalytic reaction networks](https://arxiv.org/abs/2603.19850)
...
### [7] [Pareto fronts and trade-off relations from exact multi-objective optimization of thermal machines](https://arxiv.org/abs/2603.19885)
...
### [8] [Macroscopic Mpemba Effect from Cumulative-Heat-Enhanced Relaxation](https://arxiv.org/abs/2603.19887)
...
### [9] [Strong Violation of the Thermodynamic Uncertainty Relation in a Minimal Autonomous Heat Engine](https://arxiv.org/abs/2603.20041)
...
### [10] [Edge Currents Shape Condensates in Chiral Active Matter](https://arxiv.org/abs/2603.20064)
...
### [11] [Detecting the 3D Ising model phase transition with a ground-state-trained autoencoder](https://arxiv.org/abs/2603.20157)
...
### [12] [Crossover and Critical Behavior in the Layered XY Model](https://arxiv.org/abs/2603.19351)
...
### [13] [Lattice Dynamics of LiFeAs studied by Inelastic Neutron Scattering and Density Functional Theory calculations](https://arxiv.org/abs/2603.19956)
...
### [14] [$Δ_T$ Noise, Quantum Shot Noise, and Thermoelectric Clues to the Pairing Puzzle in Iron Pnictides](https://arxiv.org/abs/2603.20069)
...
### [15] [Local asymmetry in interference as a probe of quantum probability](https://arxiv.org/abs/2603.19342)
*Yong Zhang*
...
### [16] [Assessing Spatiotemporally Correlated Noise in Superconducting Qubits via Pulse-Based Quantum Noise Spectroscopy](https://arxiv.org/abs/2603.19373)
...
### [17] [Semidefinite block-matrix relaxations for computing quantum correlations](https://arxiv.org/abs/2603.19388)
...
### [18] [Approximate virtual quantum broadcasting](https://arxiv.org/abs/2603.19476)
...
### [19] [Heralded quasi-deterministic entanglement sources based on spontaneous parametric down-conversion](https://arxiv.org/abs/2603.19489)
...
### [20] [Preserving MWPM-Decodability in Fault-Equivalent Rewrites](https://arxiv.org/abs/2603.19522)
...
### [21] [Stabilizer Formalism for EAQECCs with Noise ebits](https://arxiv.org/abs/2603.19597)
...
### [22] [Universal method for optimized robustness in self-testing of quantum resources](https://arxiv.org/abs/2603.19612)
...
### [23] [Beyond-Ten-Hour Coherence in a Decoherence-Free Trapped-Ion Clock Qubit](https://arxiv.org/abs/2603.19631)
...
### [24] [Structure and Classification of Matrix Product Quantum Channels](https://arxiv.org/abs/2603.19866)
...
### [25] [Transfer of nonlocality and entanglement of an open three-qubit W state in the background of dilaton black hole](https://arxiv.org/abs/2603.19785)
...
### [26] [Bright oxygen- and vacancy-derived spin-singlet diamond color centers with metastable spin triplets: OV$^{2+}$ and VOV$^{2+}$](https://arxiv.org/abs/2603.20073)
...
### [27] [Linear-optical generation of hybrid GKP entanglement from small-amplitude cat states](https://arxiv.org/abs/2603.19870)
...
### [28] [SDP bounds on quantum codes: rational certificates](https://arxiv.org/abs/2603.19901)
...
### [29] [Quantum gyroscope based on three-dimensional rotation induced Berry phase](https://arxiv.org/abs/2603.19906)
...
### [30] [Efficiently Computable Strategies and Limits for Bosonic Channel Discrimination](https://arxiv.org/abs/2603.19911)
...
### [31] [One-parameter counterexamples to the refined Bessis-Moussa-Villani conjecture](https://arxiv.org/abs/2603.19927)
*Hyunho Cha*
...
### [32] [Adaptive Parallelism-Aware Qubit Routing for Ion Trap QCCD Architectures](https://arxiv.org/abs/2603.19969)
...
### [33] [Stone-in-Waiting: A Cloud-Based Accelerator for the Quantum Approximate Optimization Algorithm](https://arxiv.org/abs/2603.19980)
*Shuai Zeng*
...
### [34] [Cryptanalysis of four arbitrated quantum signature schemes](https://arxiv.org/abs/2603.19985)
...
### [35] [Layered Quantum Architecture Search for 3D Point Cloud Classification](https://arxiv.org/abs/2603.20024)
...
### [36] [Variance reduction methods in the estimation of Pauli sums](https://arxiv.org/abs/2603.20029)
...
### [37] [Full Network Nonlocality Based Security In Quantum Key Distribution](https://arxiv.org/abs/2603.20035)
*Kaushiki Mukherjee*
...
### [38] [Search-Driven Clause Learning for Product-State Quantum $k$-SAT (PRODSAT-QSAT)](https://arxiv.org/abs/2603.20038)
...
### [39] [Antenna Array Beamforming Based on a Hybrid Quantum Optimization Framework](https://arxiv.org/abs/2603.20072)
*Shuai Zeng*
...
### [40] [A single programmable photonic circuit for universal quantum measurements](https://arxiv.org/abs/2603.20085)
...
### [41] [Symmetric Resourceful Steady States via Non-Markovian Dissipation](https://arxiv.org/abs/2603.20091)
...
### [42] [Heisenberg-scaling characterization of an arbitrary two-channel network via two-port homodyne detection](https://arxiv.org/abs/2603.20139)
...
### [43] [Quantum inference on a classically trained quantum extreme learning machine](https://arxiv.org/abs/2603.20167)
...
### [44] [Certified Quantum Schrödinger Control via Hierarchical Tucker Models](https://arxiv.org/abs/2603.20168)
...
### [64] [Anatomy of the modern theory of orbital magnetism from first-principles: term-by-term analysis in the gauge-covariant formalism](https://arxiv.org/abs/2603.19875)
...
### [65] [Micromagnetic Modeling of Surface Acoustic Wave Driven Dynamics: Interplay of Strain, Magnetorotation, and Magnetic Anisotropy](https://arxiv.org/abs/2603.20106)
