...
### [4] [Bilinear correlations in Fluctuating Gaussian States with anti-unitary symmetries](https://arxiv.org/abs/2609.01724)
*Xu Zhang*
...
### [5] [Numerical simulation of D-Wave's quantum advantage experiment with time-dependent variational Monte Carlo](https://arxiv.org/abs/2609.01719)
*Roeland Wiersema*
...
### [6] [Renormalization group and long-range conditional mutual information in hierarchical models](https://arxiv.org/abs/2609.02141)
*Yu-Hsueh Chen*
...
### [8] [Effective quasiparticle conserving Lindbladians in the thermodynamic limit](https://arxiv.org/abs/2609.02725)
...
### [17] [Need One Bell-pair Only (NOBOL) for Low-Overhead Fault-Tolerant Quantum Computing](https://arxiv.org/abs/2609.01901)
...
### [19] [Quantum Circuit and Tensor Network Implementation of the 2D Acoustic Wave Equation](https://arxiv.org/abs/2609.01904)
...
### [59] [Piston-Like Information Engine II: Boundary-Controlled Optimum in Active Matter](https://arxiv.org/abs/2609.01760)
...
### [60] [Microscopic dynamics of contagion using active Brownian particles: universal scaling and propagation controlled by protection](https://arxiv.org/abs/2609.01927)
...
### [61] [Nonequilibrium corrections to conserved Ising criticality in scalar active matter: Ward identities, spectrum, and long crossovers](https://arxiv.org/abs/2609.02351)
*Piotr Zdybel*
...
### [62] [Effect of reactive targets on diffusive transport with intermittent restarts](https://arxiv.org/abs/2609.02355)
...
### [63] [Impedance in Periodically Driven Stochastic Systems](https://arxiv.org/abs/2609.02458)
...
### [64] [Branching stochastic mechanics. II. Relative localization and collective poles from Bohm/Fisher feedback](https://arxiv.org/abs/2609.02520)
...
### [65] [Memory-driven Topological Defects and Unconventional Long-Range Order](https://arxiv.org/abs/2609.02586)
*Ziyang Ding,Zi Cai*
...
### [66] [Thermodynamic optimization of thermal landscapes and energy barriers in a Brownian heat engine](https://arxiv.org/abs/2609.02613)
*Mesfin Taye*
...
### [67] [Survival in a partially reactive wedge](https://arxiv.org/abs/2609.02665)
*Denis S. Grebenkov*
...
### [68] [Optimal-work feedback on particles with activity --- gliding on active fluctuations using positional information](https://arxiv.org/abs/2609.02720)
...
### [69] [Tuning Boron-Vacancy Qubit Coherence through Layer Number in hBN](https://arxiv.org/abs/2609.01812)
...
### [70] [Magnons in Metallic Altermagnetic $\text{KV}_2\text{Se}_2\text{O}$](https://arxiv.org/abs/2609.01853)
...
### [71] [Complete Topological Classification with P and T Symmetries: Revealing a Topological Invariant Invisible to K-Theory](https://arxiv.org/abs/2609.02025)
*Chen Zhang,Y. X. Zhao*
...
### [72] [Persistence and emergence of quantum defects through pressure-induced phase changes](https://arxiv.org/abs/2609.02100)
...
### [73] [In silico design of magnonic lasing in constricted waveguides](https://arxiv.org/abs/2609.02338)
...
### [74] [Room-temperature local strain control of moiré excitons in MoS$_2$/WSe$_2$ heterobilayers](https://arxiv.org/abs/2609.02340)
...
### [75] [Direct observation of flat bands in near-magic-angle twisted bilayer CVD graphene](https://arxiv.org/abs/2609.02403)
...
### [76] [Rank-Selective Optical Tomography of Higher-Wave Altermagnetism](https://arxiv.org/abs/2609.02429)
...
### [77] [Direct Observation of the Zigzag Edge States of a Supramolecular Diatomic Kagome Lattice](https://arxiv.org/abs/2609.02567)
...
### [78] [Nonreciprocal Magnon Hanle Effect in Antiferromagnetic $α$-Fe$_2$O$_3$](https://arxiv.org/abs/2609.02631)
...
### [79] [Twist as a Mechanical Switch for Reconfigurable Stacking in h-BN](https://arxiv.org/abs/2609.02723)
...
### [80] [QArray+: A physics-informed GPU-accelerated simulator for quantum dot arrays](https://arxiv.org/abs/2609.02736)
...
### [81] [Emergence of the magnetic octupole Rashba-Edelstein effect from spin-orbit entanglement](https://arxiv.org/abs/2609.02768)
...
### [82] [Relaxation effects on Hartree-Fock ground states in twisted bilayer graphene at even integer fillings](https://arxiv.org/abs/2609.02815)
...
### [83] [Interaction effects on Andreev states from an electromagnetic environment](https://arxiv.org/abs/2609.01935)
...
### [84] [Vortex-core Majorana coupling to a chiral edge in a $p_x+ip_y$ superconductor: Nonmonotonic spectral reorganization and coherent fermion-parity dynamics](https://arxiv.org/abs/2609.02260)
*Peiyao Liu,Yi Zhou*
...
### [85] [Anomalous Superfluid Response in Altermagnetic Superconductors](https://arxiv.org/abs/2609.02263)
...
### [86] [Quantum Structural Renormalization and Anharmonic Stabilization of Superconductivity in P4/mmm YScH8](https://arxiv.org/abs/2609.02295)
...
### [87] [Electronic Structure and Superconductivity in La$_{1.55}$Sr$_{0.45}$CuO$_4$/La$_2$CuO$_4$ Artificial High-$T_c$ Superlattices Probed by Hard and Soft X-ray Spectroscopy](https://arxiv.org/abs/2609.02668)
...
### [88] [Evolution from Kitaev to XXZ spin chains via distortion: Application to BaCo$_2$V$_2$O$_8$](https://arxiv.org/abs/2609.01805)
...
### [89] [Observation of g-wave altermagnetic multipole](https://arxiv.org/abs/2609.01969)
...
### [90] [Thermodynamic Electric Toroidal Dipole and Intrinsic Longitudinal Spin Transport](https://arxiv.org/abs/2609.02443)
...
### [91] [Prominent Dimensional Effects on High-order Harmonic Generation in Strongly Correlated Electron Systems](https://arxiv.org/abs/2609.02466)
...
### [92] [Disorder-driven competing magnetic interactions and glassy magnetic behavior in quaternary Heusler alloy FeRuMnGe](https://arxiv.org/abs/2609.02506)
