...
### [1] [Topological superconductivity in an altermagnet-superconductor heterostructure](https://arxiv.org/abs/2609.13408)
...
### [2] [Spatial instability of a homogeneous superconductor after an interaction quench](https://arxiv.org/abs/2609.13426)
...
### [3] [Wrinkles and Magnetic Flux Trapping in Graphite Nanoflakes: A Possible Source and Manifestation of Room-Temperature Superconductivity](https://arxiv.org/abs/2609.15712)
...
### [4] [Structured Quantum Kernels for Chaotic Forecasting](https://arxiv.org/abs/2609.13360)
...
### [12] [An entropic characterization of Haag duality](https://arxiv.org/abs/2609.13550)
...
### [14] [Batched pattern search for QAOA parameter optimization on cloud-accessed quantum hardware](https://arxiv.org/abs/2609.13669)
*Muhammad Faryad*
...
### [15] [Time domain non-linear quantum interferometry](https://arxiv.org/abs/2609.13749)
...
### [16] [What Output-Equivalence Oracles Miss: An Empirical Study of Equivalence-Invisible Bug Fixes in Quantum Transpilers (Qiskit, tket, Cirq)](https://arxiv.org/abs/2609.13839)
...
### [17] [Hiai--Petz Skew Informations and Sharp Uncertainty Relations for a Single Observable](https://arxiv.org/abs/2609.13870)
*Gen Kimura*
...
### [20] [No cardinality bound for squashed entanglement](https://arxiv.org/abs/2609.14031)
...
### [21] [Formulating Multistage Cutting Stock Problems as QUBO](https://arxiv.org/abs/2609.14070)
...
### [22] [Torsion detection in clique complexes is conditionally $QMA_1$-hard](https://arxiv.org/abs/2609.14110)
*Adam Wesołowski*
...
### [23] [Fast CZ gate in hybrid fluxonium-transmon systems with tunable couplers](https://arxiv.org/abs/2609.14197)
...
### [24] [Trace-Norm Overlaps of Quantum States: Interpolation, Equality, and Data-Processing Rigidity](https://arxiv.org/abs/2609.14203)
...
### [25] [An All-van-der-Waals Qubit](https://arxiv.org/abs/2609.14230)
...
### [26] [Quantum synchronization: A tutorial guide](https://arxiv.org/abs/2609.14375)
...
### [27] [Certification cost of quantum models: measurement correlation, not parameter count](https://arxiv.org/abs/2609.14424)
...
### [28] [Indistinguishability Theory for Identical Particles with Invariant Degrees of Freedom](https://arxiv.org/abs/2609.14428)
*Valery Shchesnovich*
...
### [29] [Exact computation of quantum wave functions for nonlinear potentials](https://arxiv.org/abs/2609.14480)
...
### [30] [Parameter-Efficient Quantum NLP for Paraphrase Detection: Performance, Robustness, and Entanglement](https://arxiv.org/abs/2609.14529)
...
### [31] [Proving olympiad geometry theorems on a superconducting quantum processor](https://arxiv.org/abs/2609.14533)
...
### [32] [Controlling quantum state transfer in rooted products](https://arxiv.org/abs/2609.14537)
...
### [33] [Exact $1/4$ mean-rung population and $\sqrt{2}$ continuum revival-time ratio in the anti-Jaynes--Cummings vertex at $f_\star=\sqrt{\bar n+1}$](https://arxiv.org/abs/2609.14563)
...
### [34] [Simulating Quantum Physics Experiments One Event at a Time](https://arxiv.org/abs/2609.14600)
*Hans De Raedt*
...
### [35] [A pretty-tight converse on the classical capacity of generalized amplitude-damping channels](https://arxiv.org/abs/2609.14621)
*Kun Fang*
...
### [36] [Linear equations mod $n$ are pseudo-telepathic](https://arxiv.org/abs/2609.14632)
*Lorenzo Ciardo*
...
### [37] [Collective-dissipation-controlled thermal rectification and entropy production in a three-terminal three-qubit XXZ spin chain](https://arxiv.org/abs/2609.14644)
...
### [38] [Systematic construction of multiqubit unextendible product bases](https://arxiv.org/abs/2609.14788)
...
### [39] [Universal Defect Statistics in Reverse Quenches](https://arxiv.org/abs/2609.14960)
...
### [40] [Fermionic quantum error correction is never free](https://arxiv.org/abs/2609.15059)
...
### [41] [Biorthogonal Time-Dependent Variational Principle for Non-Hermitian Systems](https://arxiv.org/abs/2609.15099)
...
### [42] [A train--prune--readout--rewrite workflow for interpretable quantum learning](https://arxiv.org/abs/2609.15139)
...
### [43] [Comment on J.Qin et al., Unconditional and Robust Quantum Metrological Advantage beyond N00N States, PRL 130, 070801 (2023) and J.A. H. Nielsen et.al., Deterministic Quantum Phase Estimation beyond N00N States. PRL 130, 123603 (2023)](https://arxiv.org/abs/2609.15212)
...
### [44] [Feature-Adaptive Fusion in Hybrid Quantum-Classical Neural Networks for Robust Biomedical Image Classification](https://arxiv.org/abs/2609.15267)
...
### [45] [Klein Tunneling of Dirac Fermions through Electromagnetic Barriers](https://arxiv.org/abs/2609.15287)
...
### [46] [Universality from Quadratic Angular-Momentum Operations: Exact Dynamical Lie Algebras and the Role of the Casimir Obstruction](https://arxiv.org/abs/2609.15302)
...
### [47] [Improving precision scaling via backaction-evading continuous measurement in a driven-dissipative Kerr parametric oscillator](https://arxiv.org/abs/2609.15345)
...
### [48] [Electromagnetic Selection Rules and Coherent Manipulation of Quantum Skyrmion via Surface Acoustic Wave Phonons](https://arxiv.org/abs/2609.15456)
...
### [49] [Engineering dissipation and control pulses for high-fidelity fault-tolerance quantum computing](https://arxiv.org/abs/2609.15477)
...
### [50] [Bell-inequality violation in light transmitted through disordered emitter ensembles](https://arxiv.org/abs/2609.15575)
...
### [51] [Information Erasure and Quantum Imprint in Quantum Measurement and First-Order SPAM Error Separation](https://arxiv.org/abs/2609.15586)
...
### [52] [Parametric two-qubit gates via Landau-Zener interference](https://arxiv.org/abs/2609.15604)
...
### [53] [OpenQARP: a modular framework for quantum application research](https://arxiv.org/abs/2609.15697)
...
### [54] [Performance in Symmetry-Restricted Searches for Post-Quantum Correlations](https://arxiv.org/abs/2609.15705)
...
### [55] [A Modular, Topology-Aware Software Stack for Entanglement-Based Distributed Quantum Computing](https://arxiv.org/abs/2609.15728)
...
### [56] [Pauli spectrum and nonstabilizerness of random fermionic Gaussian states](https://arxiv.org/abs/2609.15739)
...
### [57] [Optimal entanglement-assisted source coding under a balanced-difference promise](https://arxiv.org/abs/2609.15757)
*Julius A. Zeiss*
...
### [59] [Security framework for practical quantum key distribution with imperfect devices](https://arxiv.org/abs/2609.15790)
...
### [60] [Higher-order quantum thermodynamics: equilibrium and causal structure](https://arxiv.org/abs/2609.15829)
...
### [61] [Limits on the atomic description of four-wave mixing](https://arxiv.org/abs/2609.15843)
...
### [62] [Generation of entanglement and magic via continuous homodyne monitoring of a qubit pair](https://arxiv.org/abs/2609.15868)
...
### [63] [Strong-coupling quantum optics in free space with holes in a Fermi sea](https://arxiv.org/abs/2609.15935)
...
### [64] [Quantum Stochastic Walks on the Permutation Group](https://arxiv.org/abs/2609.13387)
...
### [65] [Tripartite entanglement in chaotic eigenstates](https://arxiv.org/abs/2609.13411)
...
### [66] [Layer- and Orbital-Selective Mott Physics Driving Dimensional Crossover in Nickelate Superlattices](https://arxiv.org/abs/2609.13723)
...
### [67] [Exact solutions of hidden free fermion models](https://arxiv.org/abs/2609.14134)
...
### [68] [Vestigial altermagnetism](https://arxiv.org/abs/2609.14228)
...
### [69] [Charge order before superconductivity in the doped kagome Dirac spin liquid](https://arxiv.org/abs/2609.15947)
*Yasir Iqbal*
...
### [70] [Twinning of domains and spin anisotropy in K$_5$Fe$_4$Ag$_6$Te$_{10}$](https://arxiv.org/abs/2609.15290)
...
### [71] [Engineering Competing Fractional Topological States in a BHZ Superlattice](https://arxiv.org/abs/2609.15300)
...
### [72] [Fractional vortices in a spin-isotropic spiral spin liquid](https://arxiv.org/abs/2609.15941)
...
### [73] [Probing the anomalous symmetry-breaking in kagome material CsV3Sb5 via third-order nonlinearity](https://arxiv.org/abs/2609.13656)
...
### [74] [Rhombohedral Multilayer Graphene as a $p$-Wave Magnet](https://arxiv.org/abs/2609.14705)
...
### [75] [Quantum Hall Ferromagnetism in a Cavity Vacuum](https://arxiv.org/abs/2609.14838)
...
### [76] [Spectral density of angular momentum transfer from a swift electron to a large spherical nanoparticle](https://arxiv.org/abs/2609.14319)
...
### [77] [Quasilocal transport in the integer quantised Hall effect: adiabatic separation, local Ohm's law, and Joule heating of the incompressible strips](https://arxiv.org/abs/2609.15231)
*A. Siddiki*
...
### [78] [Optical activation of nonlinear Hall effect in topological insulators with warped Fermi surface](https://arxiv.org/abs/2609.15460)
...
### [79] [Percolation threshold in cluster-assembled nanogranular palladium films and related strategies for hydrogen detection](https://arxiv.org/abs/2609.15629)
...
### [80] [Effects of residual exchange coupling on simultaneously driven spin qubits](https://arxiv.org/abs/2609.15751)
