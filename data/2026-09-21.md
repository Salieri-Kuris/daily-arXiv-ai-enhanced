...
### [13] [Semiclassical Arrhenius law for quantum-thermal escape rates](https://arxiv.org/abs/2609.21625)
...
### [14] [Unconditional quantum advantage from a two-round CHSH problem in one dimension](https://arxiv.org/abs/2609.21237)
...
### [17] [Pair density Shannon information measures and their $N$-dependent behaviour in diatomic molecular systems](https://arxiv.org/abs/2609.21260)
...
### [18] [Floquet physics from quantized light-matter interaction: geometric phases, gauge consistency, and entanglement](https://arxiv.org/abs/2609.21741)
...
### [48] [Bootstrapping Classical Systems with Quenched Disorder](https://arxiv.org/abs/2609.20927)
...
### [49] [Arctic Curves and a Gapped Gas Phase in a Two-Band Free-Fermion Chain](https://arxiv.org/abs/2609.21004)
...
### [50] [Functional Renormalization for Random Matrix Theory: The relational background field method](https://arxiv.org/abs/2609.21031)
...
### [51] [Persistence, resetting, and first-passage times of an active Ornstein--Uhlenbeck particle](https://arxiv.org/abs/2609.21124)
...
### [52] [Local Detailed Balance in the Lorenz Model: Replaces the Butterfly with Frenetic Bursting](https://arxiv.org/abs/2609.21415)
...
### [53] [The charge dependent hard-sphere model: Polycrystals as low-energy configurations](https://arxiv.org/abs/2609.21508)
...
### [54] [Self-avoiding trails in two and three dimensions](https://arxiv.org/abs/2609.21724)
...
### [55] [Full macroscopic thermalization and the formation of Schrödinger's cats by unitary time evolution in the weakly perturbed Ising model - Applications of the Roos-Sugimoto-Teufel-Tumulka-Vogel theory](https://arxiv.org/abs/2609.21757)
*Hal Tasaki*
...
### [56] [Non-negative differential mobility of one-dimensional underdamped Langevin dynamics: Proof via mapping to a marginally stable oscillator](https://arxiv.org/abs/2609.21833)
*Udo Seifert*
...
### [57] [Multi-Resolution Wire-Fencing for Efficient Path Sampling](https://arxiv.org/abs/2609.21897)
...
### [58] [Universal Eigenvector Statistics of Non-Hermitian Random Matrices](https://arxiv.org/abs/2609.22079)
...
### [59] [Pressure and Proximity Tuned Twisted Bilayer Graphene](https://arxiv.org/abs/2609.20958)
...
### [60] [Singular high-harmonic transport above a quantum threshold](https://arxiv.org/abs/2609.20990)
...
### [61] [Bend Contour Electron Tomography (BCET): Quantitative strain and topography mapping](https://arxiv.org/abs/2609.21041)
...
### [62] [Defect-mediated orientational ordering in stripe-forming magnetic systems](https://arxiv.org/abs/2609.21091)
...
### [63] [Projective representation theory of spin space groups](https://arxiv.org/abs/2609.21289)
...
### [64] [Rydberg excitons in core-shell nanostructures I. Optical properties](https://arxiv.org/abs/2609.21488)
...
### [65] [Floquet-spin-orbit compensation and flat- and quadratic-band contact in the $α$-$T_3$ lattice](https://arxiv.org/abs/2609.21586)
...
### [66] [Transport statistics and thermoelectric performance of Hofstadters butterfly](https://arxiv.org/abs/2609.21588)
...
### [67] [Spatially resolved quantum magnetometry and stray-field reconstruction of permalloy microdisks using boron-vacancy centers in hexagonal boron nitride](https://arxiv.org/abs/2609.21630)
...
### [68] [Field-free and Sub-ns Magnetization Reversal in Synthetic Anti-ferromagnets using Sequential Spin-Orbit Torque and Spin-Transfer Torque Pulses](https://arxiv.org/abs/2609.21669)
...
### [69] [Impact of exciton-phonon and exciton-magnon interaction on transport in anisotropic 2D magnetic semiconductors](https://arxiv.org/abs/2609.21746)
...
### [70] [Photogalvanic effect in monolayers of transition metal dichalcogenides](https://arxiv.org/abs/2609.22001)
...
### [71] [Non-Hermitian impurity scattering in graphene: Boltzmann transport and thermoelectric response](https://arxiv.org/abs/2609.22023)
...
### [72] [Metallic Néel order stabilized by coupling between inequivalent Hubbard layers](https://arxiv.org/abs/2609.20922)
...
### [73] [Smectic Superconductivity](https://arxiv.org/abs/2609.20932)
...
### [74] [Digital-analog concept for superconducting perceptron-like neural networks](https://arxiv.org/abs/2609.21613)
...
### [75] [Collective excitation-mediated transport in nanoscale Josephson junctions that exhibit quantum confinement](https://arxiv.org/abs/2609.21725)
...
### [76] [Universal Dzyaloshinski-Moriya interaction dictates pairing in unconventional superconductor families](https://arxiv.org/abs/2609.21731)
...
### [77] [Topological properties and gap structure of the paired state in twisted TMD bilayers within a two-band effective model](https://arxiv.org/abs/2609.21825)
...
### [78] [Failure of Conventional Roughness Metrics in Assessing Field-Limiting Mesoscopic Topography in SRF Nb Films on Cu](https://arxiv.org/abs/2609.21835)
...
### [79] [Strong-coupling multigap superconductivity in the Heusler compound ScAu$_2$Al](https://arxiv.org/abs/2609.21845)
...
### [80] [Tunneling Spectroscopy Study of Low Baked Bulk Niobium for Superconducting RF Cavity Applications](https://arxiv.org/abs/2609.21865)
...
### [81] [Bootstrapping Disordered Quantum Systems](https://arxiv.org/abs/2609.20916)
...
### [82] [Shape Deformation and Braid Statistics of Fractional Quantum Hall Quasiparticles](https://arxiv.org/abs/2609.20985)
...
### [83] [Resonant spin mode from retarded relaxation](https://arxiv.org/abs/2609.21623)
*J. Beater,G. S. Uhrig*
...
### [84] [Reformulating Pfaffian Quantum Monte Carlo with the Hybrid Monte Carlo formalism](https://arxiv.org/abs/2609.21631)
...
### [85] [Orbital character and photoemission signatures of the A-pocket in infinite-layer nickelates](https://arxiv.org/abs/2609.21665)
...
### [86] [Machine learning magnetic interactions from neutron powder diffraction data](https://arxiv.org/abs/2609.21970)
...
### [87] [Unified Field Bosonization Technique for strongly inhomogenous Luttinger Liquids](https://arxiv.org/abs/2609.21973)
...
### [88] [Correlation enhanced magnetism at a superconducting cuprate/manganite interface](https://arxiv.org/abs/2609.22051)
