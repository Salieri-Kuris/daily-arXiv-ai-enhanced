...
### [12] [Extracting conformal data from finite-size tensor-network flow in critical two-dimensional classical models](https://arxiv.org/abs/2604.15749)
...
### [13] [Phase Transitions as the Breakdown of Statistical Indistinguishability](https://arxiv.org/abs/2604.15773)
...
### [14] [General perturbative framework for kinetics of rare transitions in 1-dimensional active particle systems](https://arxiv.org/abs/2604.15826)
...
### [15] [On the role of the slowest observable in one-dimensional Markov processes to construct quasi-exactly-solvable generators with $N=2$ explicit levels](https://arxiv.org/abs/2604.15908)
*Cecile Monthus*
...
### [16] [Ergodic properties of functionals of Gaussian processes](https://arxiv.org/abs/2604.15952)
...
### [17] [Exact Steady State of a One-end Driven XXZ Spin Chain with Boundary Field](https://arxiv.org/abs/2604.16102)
*V. Popkov,T. Prosen*
...
### [18] [MF-toolkit: A High-Performance Python Library for Multifractal Analysis with Automated Crossover Detection, Source Identification and Application to Gravitational Waves Data](https://arxiv.org/abs/2604.16257)
...
### [21] [Ultrastrong Coupling Signatures in Photon Statistics from Terahertz Higgs-Polaritons](https://arxiv.org/abs/2604.15417)
...
### [25] [Enhancing Neural-Network Variational Monte Carlo through Basis Transformation](https://arxiv.org/abs/2604.15888)
...
### [26] [Experimental quantification of electronic symmetry breaking through orbital hybridization phase](https://arxiv.org/abs/2604.15906)
...
### [27] [Ultrafast Current Switching from Quantum Geometry in Semimetals](https://arxiv.org/abs/2604.15924)
...
### [28] [Antiferromagnetic Dimers in the Parent Phase of a Correlated Kagome Superconductor](https://arxiv.org/abs/2604.15935)
...
### [29] [Extension of the iterated perturbation theory at arbitrary fillings to nonequilibrium steady states](https://arxiv.org/abs/2604.15942)
...
### [30] [Spinon shift current in a noncentrosymmetric quantum spin chain](https://arxiv.org/abs/2604.16063)
...
### [31] [Contribution of remote bands to orbital magnetization in twisted bilayer graphene](https://arxiv.org/abs/2603.03702)
...
### [32] [Digital Predistortion for Flux Control of Tunable Superconducting Qubits](https://arxiv.org/abs/2604.15895)
...
### [34] [A Unified Hardware-to-Decoder Architecture for Hybrid Continuous-Variable and Discrete-Variable Quantum Error Correction in LiDMaS+](https://arxiv.org/abs/2604.15389)
...
### [35] [Projected Dynamic Programming for Sequential Quantum State Discrimination](https://arxiv.org/abs/2604.15393)
...
### [36] [Optimal algorithms for materializing stabilizer states and Clifford gates from compact descriptions](https://arxiv.org/abs/2604.15405)
...
### [37] [Renormalization and Non-perturbative Dynamics in Conformal Quantum Mechanics](https://arxiv.org/abs/2604.15412)
...
### [38] [Tensor Networks with Belief Propagation Cannot Feasibly Simulate Google's Quantum Echoes Experiment](https://arxiv.org/abs/2604.15427)
...
### [39] [Efficient $n$-qubit entangling operations via a superconducting quantum router](https://arxiv.org/abs/2604.15432)
...
### [40] [Magnetic domains stabilized by symmetry-protected zero modes](https://arxiv.org/abs/2604.15510)
...
### [41] [Quantum Search without Global Diffusion](https://arxiv.org/abs/2604.15435)
...
### [42] [Finite-Time Thermodynamics of an Autonomous Information Machine](https://arxiv.org/abs/2604.15953)
...
### [43] [Parity-unfolded distillation architecture for noise-biased platforms](https://arxiv.org/abs/2604.15436)
...
### [44] [Discovering quantum phenomena with Interpretable Machine Learning](https://arxiv.org/abs/2604.16015)
...
### [45] [Quantum computation at the edge of chaos](https://arxiv.org/abs/2604.15441)
...
### [46] [Boson correlations are spurious for classical states](https://arxiv.org/abs/2604.16283)
...
### [47] [Accessible Quantum Correlations Under Complexity Constraints](https://arxiv.org/abs/2604.15540)
...
### [48] [Feature-level analysis and adversarial transfer in rotationally equivariant quantum machine learning](https://arxiv.org/abs/2604.15552)
...
### [49] [A Modular Cryogenic Link for Microwave Quantum Communication Over Distances of Tens of Meters](https://arxiv.org/abs/2604.15971)
...
### [50] [A Game Theoretic Approach for Optimizing Quantum Error Budget Distribution](https://arxiv.org/abs/2604.15603)
...
### [51] [Gravitationally induced wave-function collapse from dynamical bifurcation](https://arxiv.org/abs/2604.16144)
*C. A. S. Almeida*
...
### [52] [Many-Body Amplified Nonclassical Photon Emission in Cavity-Coupled Atomic Arrays](https://arxiv.org/abs/2604.15604)
...
### [53] [Deterministic multiphoton bundle emission via interference-interaction control](https://arxiv.org/abs/2604.15605)
...
### [54] [Overcoming the Lamb Shift in System-Bath Models via KMS Detailed Balance: High-Accuracy Thermalization with Time-Bounded Interactions](https://arxiv.org/abs/2604.15616)
...
### [55] [Bridge the Gap between Classical and Quantum Neural Networks with Residual Connections](https://arxiv.org/abs/2604.15626)
*Junxu Li*
...
### [56] [Explainable quantum regression algorithm with encoded data structure](https://arxiv.org/abs/2604.15666)
...
### [57] [Observable-Guided Generator Selection for Improving Trainability in Quantum Machine Learning with a $ \mathfrak{g} $-Purity Interpretation under Restricted Settings](https://arxiv.org/abs/2604.15693)
*Hiroshi Ohno*
...
### [58] [Quantifying Uhlmann curvature from Yang-Mills action and its implications in quantum multiparameter estimation](https://arxiv.org/abs/2604.15752)
...
### [59] [Optically detected magnetic resonance of nitrogen-vacancy centers in diamond using two-photon excitation](https://arxiv.org/abs/2604.15755)
...
### [60] [Machine-learning-assisted material and geometry characterization from Casimir force measurement](https://arxiv.org/abs/2604.15763)
...
### [62] [Spectral design principles for local-excitation retention in impurity-assisted atomic arrays](https://arxiv.org/abs/2604.15799)
*Junpei Oba*
...
### [63] [A Practical Semi-Quantum Signature Protocol with Improved Eavesdropping Detection](https://arxiv.org/abs/2604.15836)
...
### [64] [Approximate Cosine Similarity Estimation via an Angle-Encoding Hadamard Test](https://arxiv.org/abs/2604.15867)
*Hiroshi Ohno*
...
### [65] [Asymptotic optimality of Grover-Radhakrishnan-Korepin algorithm](https://arxiv.org/abs/2604.15886)
...
### [68] [MacWilliams Identities for Intrinsic Quantum Codes](https://arxiv.org/abs/2604.16023)
...
### [69] [Comment on "A General Framework for Constructing Local Hidden-state Models to Determine the Steerability"](https://arxiv.org/abs/2604.16051)
...
### [70] [Security Framework for Quantum Distance-Bounding](https://arxiv.org/abs/2604.16071)
...
### [71] [Quantum-Resistant Quantum Teleportation](https://arxiv.org/abs/2604.16101)
...
### [72] [Entanglement and photoelectron holography in dissociative photoionization: molecular quantum eraser](https://arxiv.org/abs/2604.16107)
...
### [73] [Quantum Noise Suppression Beyond the Standard Quantum Limit in a Hybrid Magnonic Optomechanical System](https://arxiv.org/abs/2604.16136)
...
### [86] [Yttrium ion as a platform for quantum information processing](https://arxiv.org/abs/2604.16274)
...
### [87] [Aziz and Howl's Gravity-Induced Entanglement Channel is Essentially Classical Mechanics](https://arxiv.org/abs/2604.16276)
...
### [88] [How to unitarily map between any two pure states with a single closed-form exponential](https://arxiv.org/abs/2604.16285)
...
### [89] [Fast, High-Fidelity Erasure Detection of Dual-Rail Qubits with Symmetrically Coupled Readout](https://arxiv.org/abs/2604.16292)
