...
### [1] [LOTUS: Layer-ordered Temporally Unified Schedules For Quantum Approximate Optimization Algorithms](https://arxiv.org/abs/2601.07851)
*Phuong-Nam Nguyen*
...
### [2] [Feature Entanglement-based Quantum Multimodal Fusion Neural Network](https://arxiv.org/abs/2601.07856)
...
### [3] [Fault-Tolerant Quantum Error Correction: Implementing Hamming-Based Codes with Advanced Syndrome Extraction Techniques](https://arxiv.org/abs/2601.07860)
...
### [4] [A Preparation Nonstationarity Loophole in Superconducting-Qubit Bell Tests](https://arxiv.org/abs/2601.08290)
...
### [7] [Local Scale Invariance in Quantum Theory: Experimental Predictions](https://arxiv.org/abs/2601.07883)
...
### [8] [Quantum circuit compilation for fermionic excitations using the Jordan-Wigner mapping](https://arxiv.org/abs/2601.07890)
*Renata Wong*
...
### [9] [Bohmian mechanics: A legitimate hydrodynamic picture for quantum mechanics, and beyond](https://arxiv.org/abs/2601.07932)
*A. S. Sanz*
...
### [10] [Attention in Krylov Space](https://arxiv.org/abs/2601.07937)
...
### [11] [Dissipative ground-state preparation of a quantum spin chain on a trapped-ion quantum computer](https://arxiv.org/abs/2601.08137)
...
### [12] [Data-driven learning of non-Markovian quantum dynamics](https://arxiv.org/abs/2601.07934)
...
### [13] [Open quantum spin chains with non-reciprocity: a theoretical approach based on the time-dependent generalized Gibbs ensemble](https://arxiv.org/abs/2601.08606)
...
### [46] [Geometric Spin Rotation in Triangular Antiferromagnets](https://arxiv.org/abs/2601.07914)
...
### [47] [Extraordinary boundary correlations at deconfined quantum critical points](https://arxiv.org/abs/2601.07923)
...
### [48] [Large room temperature anomalous Nernst effect coupled with topological Nernst effect from incommensurate spin structure in a Kagome antiferromagnet](https://arxiv.org/abs/2601.08239)
...
### [49] [Collinear Magnetic Structure in the Diamond Network Magnet EuTi$_2$Al$_{20}$](https://arxiv.org/abs/2601.08376)
...
### [50] [Linear Canonical-Ensemble Quantum Monte Carlo: From Dilute Fermi Gas to Flat-Band Ferromagnetism](https://arxiv.org/abs/2601.08552)
...
### [51] [Generalized cluster states in 2+1d: non-invertible symmetries, interfaces, and parameterized families](https://arxiv.org/abs/2601.08615)
...
### [52] [Parameterized families of 2+1d $G$-cluster states](https://arxiv.org/abs/2601.08616)
...
### [53] [Reduction of Ordered Spin Moments in Antiferromagnets of S = 5/2 Ions (Fe3+, Mn2+) Driven by Local Magnetic Excitation](https://arxiv.org/abs/2601.08702)
...
### [54] [Chiral Two-Body Bound States from Berry Curvature and Chiral Superconductivity](https://arxiv.org/abs/2601.08055)
...
### [55] [Multi-level charge fluctuations in a Si/SiGe double quantum dot device](https://arxiv.org/abs/2601.08088)
...
### [56] [Nodal-line-enhanced quantum geometric effects: anomalous and nonlinear Hall effects in the parity-mixed antiferromagnet NbMnP](https://arxiv.org/abs/2601.08317)
...
### [57] [Magnetization reversal mechanism of double-helix nanowires probed by dark-field magneto-optical Kerr effect](https://arxiv.org/abs/2601.08613)
...
### [58] [Dynamical stability by spin transfer in nearly isotropic magnets](https://arxiv.org/abs/2601.08738)
...
### [59] [Local Magnetometry from Measurement-Induced Dissipation](https://arxiv.org/abs/2601.08762)
...
### [60] [Universal Transport Theory for Paired Fractional Quantum Hall States in the Quantum Point Contact Geometry](https://arxiv.org/abs/2601.08792)
...
### [61] [Forbidden second harmonics in centrosymmetric bilayer crystals](https://arxiv.org/abs/2601.08830)
...
### [62] [Nodal Superconductivity of UTe$_2$ Probed by Field-Angle-Resolved Specific Heat on a Crystal with $T_{\rm c}=2.1$ K](https://arxiv.org/abs/2601.08201)
...
### [63] [Kinetic Blockade and Filamentary Pair Density Waves in Strain-Engineered Graphene](https://arxiv.org/abs/2601.08586)
*Tao Zhou*
...
### [64] [Coupling of Klein-Andreev Resonant States in Bi$_2$Sr$_2$CaCu$_2$O$_{8+x}$-graphene-Bi$_2$Sr$_2$CaCu$_2$O$_{8+x}$ Devices](https://arxiv.org/abs/2601.08637)
...
### [65] [Level 2.5 large deviations and uncertainty relations for non-Markov self-interacting dynamics](https://arxiv.org/abs/2601.07943)
...
### [66] [Boundary-Induced Drift and Negative Mobility in Constrained Stochastic Systems](https://arxiv.org/abs/2601.08021)
...
### [67] [A Nonlinear Mechanism for Transient Anomalous Diffusion](https://arxiv.org/abs/2601.08083)
...
### [68] [Eigenstate thermalization in thermal first-order phase transitions](https://arxiv.org/abs/2601.08347)
...
### [69] [Unavoidable Canonical Nonlinearity Induced by Gaussian Measures Discretization](https://arxiv.org/abs/2601.08381)
*Koretaka Yuge*
...
### [70] [Stochastic search with space-dependent diffusivity](https://arxiv.org/abs/2601.08740)
...
### [71] [Bayesian umbrella quadrature accelerates free-energy calculations across diverse molecular systems and processes](https://arxiv.org/abs/2601.08783)
