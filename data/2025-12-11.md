...
### [1] [Anisotropic scattering rates in strain-tuned Sr$_2$RuO$_4$](https://arxiv.org/abs/2512.09024)
*Ben Currie,David T. S. Perkins,Evgeny Kozik,Joseph J. Betouras,Jörg Schmalian*

Main category: cond-mat.str-el

TL;DR: The paper analyzes the scattering rate in Sr2RuO4 under strain, explaining observed behavior as a mix of linear and quadratic contributions, with predictions for anisotropy and strain effects.


<details>
  <summary>Details</summary>
Motivation: Motivated by recent ARPES experiments, the study aims to understand the scattering rate behavior in Sr2RuO4 under strain, particularly near the Lifshitz transition.

Method: Analysis of the temperature, frequency, and momentum dependence of the single-particle scattering rate in a model of the γ-band of Sr2RuO4 under strain, focusing on behavior near the Lifshitz transition.

Result: The scattering rate becomes strongly anisotropic at the Lifshitz point. At low energies, it follows universal behavior (τ^{-1}∼ω at the Van Hove point, τ^{-1}∼ω^{3/2} elsewhere), while higher energies show significant ω^2 corrections. The observed α≈1.4(2) behavior is explained by combining linear and quadratic contributions.

Conclusion: The study provides a quantitative explanation for the experimentally observed scattering rate behavior in Sr2RuO4 under strain, showing it as a superposition of linear and quadratic contributions rather than a new universal power law. It also predicts distinctive anisotropy, strain dependence, and non-monotonic frequency dependence, offering testable predictions for future experiments.
...
### [2] [How a bilayer Nickelate superconducts: a Quantum Monte Carlo study](https://arxiv.org/abs/2512.09025)
*Xu Zhang*

Main category: cond-mat.str-el

TL;DR: Determinant Quantum Monte Carlo reveals the interplay of doping, inter-layer tunneling, and Hund's coupling in bilayer Nickelate La3Ni2O7, uncovering exciton condensation and its competition with superconductivity, with insights on enhancing SC transition temperature.


<details>
  <summary>Details</summary>
Motivation: To understand the factors stabilizing superconductivity in bilayer Nickelate La3Ni2O7 and explore the connection between exciton condensation and the observed density wave state.

Method: Determinant Quantum Monte Carlo is used to study the system, focusing on realistic dispersion and interaction parameters. The auxiliary-field-decoupled fermion Hamiltonian exhibits Kramers anti-unitary symmetries, preventing sign problems.

Result: The study identifies a second instability towards (π,π) exciton condensation in the strong interaction limit and clarifies the decisive role of inter-layer tunneling in the competition between SC and exciton condensation.

Conclusion: The paper investigates the interplay between doping, inter-layer tunneling, and onsite Hund's coupling in stabilizing superconductivity in a two-orbital model for bilayer Nickelate La3Ni2O7, highlighting the role of inter-layer tunneling in the competition between SC and exciton condensation. It also discusses potential ways to enhance SC transition temperature and stabilize the SC phase.
...
### [3] [Microscopic Theory Revealing Dual Field-Induced Transitions in Spin-1/2 Screw-Chain Magnets](https://arxiv.org/abs/2512.09039)
...
### [4] [Magnetochiral eigenstate of the Heisenberg chain with spontaneous symmetry breaking](https://arxiv.org/abs/2512.09107)
*Tigran A. Sedrakyan,Junjun Pang,Chenan Wei,Baigeng Wang*

Main category: cond-mat.str-el

TL;DR: The paper proposes a protocol to create high-energy eigenstates in quantum systems via deformed Hamiltonians, solving them for the Heisenberg XXX chain, yielding a critical, symmetry-breaking state with ballistic transport.


<details>
  <summary>Details</summary>
Motivation: The motivation is to explore atypical high-energy eigenstates in quantum systems and understand their properties, such as breaking SU(2), time-reversal, and parity symmetries while remaining critical.

Method: The study employs a chiral Hamiltonian constructed from scalar-chirality charge and total magnetization, solved exactly using the Bethe ansatz for the spin-1/2 Heisenberg XXX chain.

Result: The protocol successfully constructs a magnetized, current-carrying XXX eigenstate that breaks symmetries but stays critical, exhibiting ballistic spin and chirality transport.

Conclusion: The proposed protocol offers a novel way to study high-energy eigenstates in quantum systems, with potential applications in experimental platforms like cold-atoms and Rydberg systems.
...
### [5] [Observation of ubiquitous charge correlations and hidden quantum critical point in hole-doped kagome superconductors](https://arxiv.org/abs/2512.09256)
...
TL;DR: The study uncovers fragmented CDW phases in CsV3Sb5-xSnx using nuclear quadrupole resonance, revealing a hidden quantum critical point at x=0.12 where ISD-π CDW order would vanish, highlighting the roles of disorder and doping in shaping these phases.


<details>
  <summary>Details</summary>
Motivation: To understand the interplay between superconductivity and charge-density wave (CDW) order, particularly in hole-doped kagome compounds, which exhibit puzzling double-dome superconductivity and whose properties are poorly understood due to quenched disorder introduced by chemical substitution.

Method: The researchers employed nuclear quadrupole resonance to probe local and static orderings in the charge landscape of CsV3Sb5-xSnx, allowing them to observe incipient and fragmented CDW phases, as well as static CDW puddles above the transition temperature.

Result: Static CDW puddles were observed above the transition temperature, indicating pinning by defects. The ISD-π CDW order persists beyond previous reports, though its volume fraction decreases with doping until it saturates at the critical doping level. Carrier doping fragments the ISD-π order, while randomness preserves it.

Conclusion: The study reveals a hidden quantum critical point at a doping level of x=0.12, where the ISD-π CDW order would vanish in the absence of disorder. This critical point lies between the two superconducting domes. The research underscores the role of disorder in preserving fragmented CDW phases beyond previously reported limits, while carrier doping promotes their fragmentation.
...
### [6] [Modified Kondorsky Domain Reversal in Microstructured Phase-Separated Manganites](https://arxiv.org/abs/2512.09306)
*Monique Kubovsky,Dylan Tagrin,Amlan Biswas*

Main category: cond-mat.str-el

TL;DR: Study on LP5CMO microstructures shows domain reversal follows a modified Kondorsky model, influenced by confined geometries, suggesting potential for low current density magnetic control.


<details>
  <summary>Details</summary>
Motivation: To understand the domain reversal mechanism in hole-doped manganite microstructures, focusing on the influence of confined geometries and local magnetic fields.

Method: Fabricated (La$_{0.5}$Pr$_{0.5}$)$_{0.67}$Ca$_{0.33}$MnO$_{3}$ (LP5CMO) microstructures using photolithography on thin films grown on (110) NdGaO$_3$ substrates and investigated domain reversal through magnetotransport measurements.

Result: Microstructures followed a modified Kondorsky model, differing from bulk films which adhered to the standard model, indicating significant influence of local magnetic fields from reversed domains on coercive fields in confined geometries.

Conclusion: The study establishes magnetotransport measurements as a feasible method for probing shape and magnetocrystalline anisotropy competition in manganite microstructures, offering potential for low current density magnetic domain control.
...
### [7] [Low-dimensionality-induced tunable ferromagnetism in SrRuO$_3$ ultrathin films](https://arxiv.org/abs/2512.09320)
...
### [8] [Transport properties and thermopower of the spinful Sachdev-Ye-Kitaev dot](https://arxiv.org/abs/2512.09494)
...
### [9] [Single-crystal growth, structural characterization, and physical properties of a decorated square-kagome antiferromagnet KCu$_7$TeO$_4$(SO$_4$)$_5$Cl](https://arxiv.org/abs/2512.09584)
...
### [10] [Contrasting magnetic behavior in MnSc_2X_4 (X = S, Se) spinel compounds investigated by magnetoelastic studies](https://arxiv.org/abs/2512.09698)
...
### [11] [Single particle dynamical signature of topology induced by single mode cavities in Su-Schrieffer-Heeger chain](https://arxiv.org/abs/2512.09520)
*Fabrizio Pavan,Grazia Di Bello,Giulio De Filippis,Carmine Antonio Perroni*

Main category: cond-mat.stat-mech

TL;DR: 摘要研究了一维SSH链中单一粒子与腔模耦合后的非平衡行为，发现MCD的频率依赖性行为可以作为拓扑相变和驱动耗散拓扑的探针。


<details>
  <summary>Details</summary>
Motivation: 研究动机是基于环境和拓扑系统之间的相互作用对拓扑相变的观测和追踪是一个关键问题。通过MCD这一探针，可以更有效地提取拓扑不变量。

Method: 研究方法是采用一维SSH链中单一粒子的动力学，并分析其与多个腔模耦合后的非平衡行为，特别是MCD的表现。

Result: 研究结果表明，当频率大于静态跳跃振幅时，MCD会出现不连续的跳跃；而当频率与静态跳跃振幅相近时，拓扑序与耗散效应竞争，MCD会平滑变化但仍保留驱动耗散拓扑的信息。

Conclusion: 论文结论是环境相互作用在多体或开放系统中拓扑相变的观测和追踪是一个重要挑战。MCD作为一种强大的体探针，可以用来提取拓扑不变量，但耦合到腔模后，其行为会受到频率和耗散效应的显著影响。
...
### [12] [Synchronization of thermodynamically consistent stochastic phase oscillators](https://arxiv.org/abs/2512.09718)
...
### [13] [Burgers equation from non-thermal stationary states in nearly-integrable gases](https://arxiv.org/abs/2512.09726)
*Paweł Lisiak,Maciej Łebek,Miłosz Panfil*

Main category: cond-mat.stat-mech

TL;DR: In weakly coupled integrable systems, non-thermal states lead to Burgers equation in the hydrodynamic limit, validated by theory and simulations.


<details>
  <summary>Details</summary>
Motivation: To investigate the dynamics of density in weakly coupled integrable systems interacting with a larger reservoir, particularly how transport behaves on non-thermal states.

Method: A variant of the Chapman-Enskog theory is used to compute the diffusion constant and nonlinear Euler-scale coupling of the Burgers equation. Numerical simulations of velocity swap models validate the theoretical predictions.

Result: For non-parity-invariant states, Burgers equation arises in the hydrodynamic limit, with the theory and simulations showing excellent agreement.

Conclusion: For weakly coupled integrable systems, the dynamics of density on large scales is governed by diffusion, but this alters when transport is studied on non-thermal states. Burgers equation emerges in the hydrodynamic limit for states non-invariant under parity, with the diffusion constant and nonlinear Euler-scale coupling computed using Chapman-Enskog theory. The theory agrees well with numerical simulations of velocity swap models, confirming the conclusions based on Galilean invariance, small coupling, and minimal momentum exchange.
...
### [14] [Hitting the blinking target under stochastic resetting](https://arxiv.org/abs/2512.09739)
...
### [15] [Burgers dynamics for Poisson point process initial conditions of the Weibull class](https://arxiv.org/abs/2512.09813)
*Patrick Valageas*
...
### [16] [An ETH-ansatz-based environmental-branch approach to master equation](https://arxiv.org/abs/2512.09007)
*Wen-ge Wang*

Main category: quant-ph

TL;DR: A method for deriving the master equation for a small quantum system coupled to a chaotic environment, avoiding traditional approximations and leveraging environmental dynamics.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the limitations of traditional approximations (Born and Markov) in deriving master equations for small quantum systems coupled to chaotic environments, aiming for a more accurate and generalizable approach.

Method: The method involves deriving the master equation through a second-order expansion of a formal expression for the evolution of environmental branches, under Schrödinger evolution with specific initial conditions. It avoids the Born and Markov approximations, focusing instead on the environment's dynamic properties.

Result: The result is a novel derivation of the master equation for a generic small quantum system coupled to a chaotic environment, based on dynamic properties of the environment and without relying on the Born or Markov approximations.

Conclusion: The paper successfully develops a method to derive the master equation for a small quantum system coupled to a chaotic environment, avoiding traditional approximations like the Born and Markov approximations. The approach leverages dynamic properties of the environment for its approximations.
...
### [17] [The Richness of Bell Nonlocality: Generalized Bell Polygamy and Hyper-Polygamy](https://arxiv.org/abs/2512.09034)
...
### [18] [Slow dynamics and magnon bound states in the 2D long-range quantum Ising model](https://arxiv.org/abs/2512.09037)
...
### [19] [Optimizing the dynamical preparation of quantum spin lakes on the ruby lattice](https://arxiv.org/abs/2512.09040)
*DinhDuy Vu,Dominik S. Kufel,Jack Kemp,Lode Pollet,Chris R. Laumann,Norman Y. Yao*

Main category: quant-ph

TL;DR: A study explores dynamically preparing quantum spin liquid states using neural quantum states, achieving extended spin-liquid properties and identifying key length scales.


<details>
  <summary>Details</summary>
Motivation: Recent experiments in Rydberg quantum simulators have sparked interest in dynamically preparing quantum spin liquid states, even when the ground state phase diagram lacks such a topological phase. The study aims to understand the microscopic nature of these states and their relationship to equilibrium spin liquid order.

Method: The researchers extend the use of approximately symmetric neural quantum states for real-time evolution and directly simulate the dynamical preparation in systems of up to $N=384$ atoms. They analyze spin liquid diagnostics as a function of the preparation protocol and optimize the extent of the quantum spin lake.

Result: The prepared state exhibits spin-liquid properties over half the system size, with a topological entanglement entropy plateauing near $γ= 
2$. Two length scales, $λ$ and $ξ$, are identified to constrain the extent of the quantum spin lake.

Conclusion: In the optimal case, the prepared state shows spin-liquid properties extending over half the system size, with a topological entanglement entropy plateauing close to $γ= 
2$. The study identifies two physical length scales $λ$ and $ξ$ which constrain the extent of the quantum spin lake $ℓ$ from above and below, providing insights into the nature of dynamically prepared quantum spin liquid states.
...
### [20] [Quantum bootstrap for central potentials](https://arxiv.org/abs/2512.09041)
...
### [21] [Dressed-state Hamiltonian engineering in a strongly interacting solid-state spin ensemble](https://arxiv.org/abs/2512.09043)
...
TL;DR: A method for direct tuning of native interactions in NV centers enhances coherence and magnetometry sensitivity, surpassing Floquet engineering.


<details>
  <summary>Details</summary>
Motivation: Floquet engineering typically reduces spin interaction strength and weakens coupling to target sensing fields, limiting metrological sensitivity.

Method: Direct tuning of native interactions in an ensemble of nitrogen-vacancy (NV) centers in diamond using dressed-state qubit encoding under a perpendicular magnetic field.

Result: A 3.2× enhancement of the dimensionless coherence parameter JT₂ and a 2.6× (8.3 dB) enhanced sensitivity in AC magnetometry compared to Floquet engineering.

Conclusion: The study provides a powerful Hamiltonian engineering tool for future research with NV ensembles and other interacting higher-spin systems.
...
### [22] [Subradiant collective states for precision sensing via transmission spectra](https://arxiv.org/abs/2512.09050)
*Diego Zafra-Bono,Oriol Rubies-Bigorda,Susanne F. Yelin*

Main category: quant-ph

TL;DR: Subradiant states in quantum emitters improve metrology sensitivity for clocks and imaging via sharp spectral features.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of subradiant states in quantum metrology due to their sharp, narrow features in the transmittance spectrum.

Method: Utilizing subradiant states in subwavelength-spaced atomic arrays and small ensembles coupled to 1D waveguides to analyze their collective optical response.

Result: Subradiant states demonstrate enhanced sensitivity for applications like atomic clock operation, emitter position imaging, and detection of detunings from electromagnetic fields or gravitational gradients.

Conclusion: Subradiant states in quantum emitter ensembles enhance sensitivity to external perturbations, with applications in atomic clocks, spatial imaging, and precise detuning detection.
...
### [23] [Quantum Clocks Tick Faster: Entanglement, Contextuality, and the Flow of Time](https://arxiv.org/abs/2512.09100)
*Karl Svozil*

Main category: quant-ph

TL;DR: An entangled clock protocol shows nonclassical time synchronization, violating Bell-type inequalities, proving its quantum nature.


<details>
  <summary>Details</summary>
Motivation: To explore whether a single clock can define spacetime's metric and investigate the quantum vs. classical nature of time synchronization.

Method: The paper introduces an Entangled Clock protocol based on singlet-state correlations and compares it with Peres' classical model.

Result: At obtuse angles, the entangled clock shows a 13 percent higher synchronized tick rate than the classical model, linked to quantum contextuality.

Conclusion: The violation of Bell-type inequalities certifies that the entangled clock's shared time standard is genuinely quantum, distinguishing it from classical models.
...
### [24] [Islands of Instability in Nonlinear Wavefunction Models in the Continuum: A Different Route to "Chaos"](https://arxiv.org/abs/2512.09109)
*W. David Wick*

Main category: quant-ph

TL;DR: The paper presents a method to verify instability criteria in wavefunction models by using test-functions, enabling analysis without exact solutions and accommodating realistic potentials in fluids and gases.


<details>
  <summary>Details</summary>
Motivation: To address the rarity of exact solutions in many-body problems and extend the applicability of instability criteria to more realistic scenarios involving inter-molecular potentials.

Method: The author proposes verifying instability criteria by plugging test-functions into computable expressions, avoiding the limitations of exact solvability in many-body problems.

Result: The instability criteria were successfully verified using the proposed method, which can handle realistic inter-molecular potentials.

Conclusion: The paper demonstrates that the instability criteria can be verified using test-functions, bypassing the need for exact solutions. This approach accommodates realistic inter-molecular potentials, making it relevant to instabilities in fluids and gases.
...
### [25] [Enhanced Squeezing and Faster Metrology from Layered Quantum Neural Networks](https://arxiv.org/abs/2512.09137)
...
### [26] [Transition rates and their applications in accelerated single-qubit for fermionic spinor field coupling](https://arxiv.org/abs/2512.09144)
...
### [27] [Exact and Efficient Stabilizer Simulation of Thermal-Relaxation Noise for Quantum Error Correction](https://arxiv.org/abs/2512.09189)
...
### [28] [Parallel accelerated electron paramagnetic resonance spectroscopy using diamond sensors](https://arxiv.org/abs/2512.09230)
*Zhehua Huang,Zhengze Zhao,Fei Kong,Zhecheng Wang,Pengju Zhao,Xiangtian Gong,Xiangyu Ye,Ya Wang,Fazhan Shi,Jiangfeng Du*

Main category: quant-ph

TL;DR: A novel cross-relaxation EPR spectroscopy method at zero field improves NV ensemble efficiency and robustness, enabling real-time monitoring of free radicals.


<details>
  <summary>Details</summary>
Motivation: To overcome the inefficiency and spectral line broadening issues in EPR spectroscopy caused by inhomogeneities in NV ensembles and targets.

Method: Utilizes an amplitude-modulated control field to tune the NV sensor, making the detection robust to sensor inhomogeneity, while zero-field EPR mitigates target inhomogeneity.

Result: Demonstrated efficient EPR measurements on an ensemble of approximately 30,000 NV centers, acquiring unambiguous EPR spectra and enabling real-time monitoring of free radical dynamics.

Conclusion: The proposed cross-relaxation EPR spectroscopy method at zero field effectively addresses inhomogeneity issues in NV ensembles, enabling efficient EPR measurements and real-time monitoring of free radical dynamics.
...
### [29] [Spontaneous Decoherence from Imaginary-Order Spectral Deformations](https://arxiv.org/abs/2512.09236)
*Sridhar Tayur*

Main category: quant-ph

TL;DR: A mechanism for spontaneous decoherence using imaginary-order spectral deformation of Hamiltonians, preserving quantum rules while dynamically suppressing interference, with applications in quantum gravity and testable predictions.


<details>
  <summary>Details</summary>
Motivation: Motivated by clock imperfections, renormalization-group corrections, and semiclassical quantum-gravity analyses leading to logarithmic spectral terms.

Method: Non-stationary-phase analysis to estimate the decay of oscillatory contributions to amplitudes or decoherence functionals, demonstrating behavior at least as O(1/|β|).

Result: The deformation suppresses interference between distinct energies through rapid oscillation of the factor E^(iβ), while preserving the Born rule and Hilbert-space inner product.

Conclusion: The mechanism of spontaneous decoherence via imaginary-order spectral deformation provides a testable framework for understanding logarithmic spectral corrections in quantum-gravity-motivated theories, with potential experimental constraints through precision measurements.
...
### [30] [Harvesting entanglement from the Lorentz-violating quantum field vacuum in a dipolar Bose-Einstein condensate](https://arxiv.org/abs/2512.09263)
*Zehua Tian,Weiping Yao,Xiaobao Liu,Mengjie Wang,Jieci Wang,Jiliang Jing*

Main category: quant-ph

TL;DR: Proposal to use a dipolar BEC and impurities to study entanglement harvesting from a Lorentz-violating quantum field vacuum, revealing unique parameter dependencies.


<details>
  <summary>Details</summary>
Motivation: To explore the transfer of nonclassical correlations from a dipolar BEC to impurities and study entanglement harvesting from a Lorentz-violating quantum field vacuum.

Method: Theoretical proposal using a dipolar BEC to emulate a vacuum field with Lorentz-violating dispersion, with impurities as Unruh-DeWitt detectors for quasiparticles.

Result: Key parameter dependencies were identified, showing that smoother detector switchings do not enhance entanglement harvesting efficiency in the Lorentz-violating case, and the violation strength can shift the optimal energy structure of detectors.

Conclusion: The study demonstrates that a dipolar BEC can serve as a platform for examining entanglement harvesting from a Lorentz-violating quantum field vacuum, revealing key parameter dependencies and deviations from the Lorentz-invariant scenario.
...
### [31] [Mpemba as an Emergent Effect of System Relaxation](https://arxiv.org/abs/2512.09324)
*Gourab Das*

Main category: quant-ph

TL;DR: The paper provides a universal model explaining the Mpemba effect in quantum systems through collective behavior and relaxation dynamics, showing its occurrence even without a shared environment.


<details>
  <summary>Details</summary>
Motivation: The motivation is to resolve the unresolved fundamental mechanism of MpE in undriven systems, where the phenomenon was first observed, by proposing a universal explanation applicable regardless of system structure or environment.

Method: The paper proposes a generic model for MpE in quantum systems following Markovian relaxation dynamics, focusing on the overlap of initial states with fast relaxation modes and the role of collective behavior.

Result: The results show that MpE occurs due to the interaction of constituents creating a fast decay mode via a shared environment, and it can also emerge in systems with anisotropic relaxation.

Conclusion: The paper concludes that the Mpemba effect (MpE) arises from the collective behavior of the system through specific relaxation dynamics, demonstrating that it can occur even in systems with anisotropic relaxation without a shared environment.
...
### [32] [Real-time collisions of fractional charges in a trapped-ion Jackiw-Rebbi field theory](https://arxiv.org/abs/2512.07748)
*Alan Kahan,Pablo Viñas,Torsten V. Zache,Alejandro Bermudez*

Main category: quant-ph

TL;DR: Trapped-ion quantum simulator of the Jackiw-Rebbi model reveals how back-reaction and quantum fluctuations affect fermion dynamics, with experimental implications.


<details>
  <summary>Details</summary>
Motivation: To simulate the Jackiw-Rebbi model in a trapped-ion system, exploring the interplay between fermionic zero modes and solitonic excitations in quantum field theory.

Method: The approach combines a Born-Oppenheimer approximation to derive an effective Peierls-Nabarro potential for kink localization, followed by a truncated Wigner approximation and fermionic Gaussian states to study quantum dynamics.

Result: The fermionic back-reaction localizes the kink, while quantum fluctuations influence its spreading and scattering dynamics, providing testable predictions for experiments.

Conclusion: The study reveals the impact of back-reaction and quantum fluctuations on the stability and dynamics of fractionalized fermions in the Jackiw-Rebbi model, with potential experimental verification in trapped-ion setups.
...
### [33] [Routes of Transport in the Path Integral Lindblad Dynamics through State-to-State Analysis](https://arxiv.org/abs/2512.09362)
*Devansh Sharma,Amartya Bose*

Main category: quant-ph

TL;DR: A new Lindblad state-to-state method extends transport analysis to general dissipative and pumping processes, showing excitonic currents in molecular aggregates.


<details>
  <summary>Details</summary>
Motivation: Addressing the limitations of non-Hermitian descriptions in analyzing general empirical processes such as pumping in quantum systems.

Method: Extension of state-to-state analysis to Lindbladian descriptions, incorporating dissipative, pumping, and decohering processes.

Result: Demonstration of steady-state excitonic currents in molecular aggregates under incoherent pumping and draining.

Conclusion: The Lindblad state-to-state method provides a new first-principles approach to quantify excitonic currents in molecular aggregates, demonstrating steady-state transport mechanisms under dissipative and pumping processes.
...
### [34] [Compact and efficient quantum frequency conversion of a fiber-pigtailed single-photon source](https://arxiv.org/abs/2512.09390)
...
### [35] [Two-Photon Bandwidth of Hyper-Entangled Photons in Complex Media](https://arxiv.org/abs/2512.09456)
*Ronen Shekel,Ohad Lib,Sébastien M. Popoff,Yaron Bromberg*

Main category: quant-ph

TL;DR: Hyper-entangled photon pairs maintain stable spatial correlations across a broad bandwidth, overcoming classical limitations in quantum imaging and communication.


<details>
  <summary>Details</summary>
Motivation: The study aims to overcome the fundamental bandwidth limitation in applications like imaging and communication caused by the wavelength sensitivity of light propagation in complex media.

Method: The study analytically and numerically demonstrates modal dispersion cancellation in various media (multimode fibers, thin diffusers, blazed gratings) using hyper-entangled photon pairs.

Result: The spatial correlations of hyper-entangled photon pairs are shown to remain stable across a broad bandwidth, enabling broadband wavefront shaping of quantum states.

Conclusion: The findings demonstrate that the spatial correlations of hyper-entangled photon pairs remain stable across a broad bandwidth, advancing the understanding of quantum light in complex media with applications in quantum imaging, communication, and sensing.
...
### [36] [Quantum error correction via purification using a single auxiliary](https://arxiv.org/abs/2512.09745)
*Chandrima B. Pushpan,Tanoy Kanti Konar,Aditi Sen De,Amit Kumar Pal*

Main category: quant-ph

TL;DR: Auxiliary-assisted purification framework corrects quantum errors, achieving unit fidelity and expanding correctable error classes, tested on low-distance codes and the Heisenberg model.


<details>
  <summary>Details</summary>
Motivation: To correct errors driving a quantum system from its ground-state subspace into excited-state sectors, particularly for low-distance quantum codes and the Heisenberg model.

Method: A joint time evolution under a specially engineered interaction Hamiltonian, followed by auxiliary measurement and post-selection.

Result: The protocol successfully purifies states to unit fidelity, with success rates determined by auxiliary energy measurements. It performs well under bit-flip, phase-flip, and amplitude-damping noises.

Conclusion: The proposed protocol achieves unit fidelity in purified states and expands the class of correctable errors, especially under amplitude-damping noise. It also adapts to practical scenarios with noise during correction.
...
### [37] [LiePrune: Lie Group and Quantum Geometric Dual Representation for One-Shot Structured Pruning of Quantum Neural Networks](https://arxiv.org/abs/2512.09469)
...
### [38] [Three-body interaction in a magnon-Andreev-superconducting qubit system: collapse-revival phenomena and entanglement redistribution](https://arxiv.org/abs/2512.09697)
...
### [39] [Can Intense Quantum Light Beat Classical Uncertainty Relations?](https://arxiv.org/abs/2512.09558)
...
### [40] [Tomographic characterization of non-Hermitian Hamiltonians in reciprocal space](https://arxiv.org/abs/2512.09870)
...
### [41] [Exceptional points of arbitrary high orders induced by non-Markovian dynamics](https://arxiv.org/abs/2512.09582)
*Timofey T. Sergeev,Evgeny S. Andrianov,Alexander A. Zyablovsky*

Main category: quant-ph

TL;DR: Non-Markovian effects allow observation of higher-order exceptional points in non-Hermitian systems beyond traditional limits.


<details>
  <summary>Details</summary>
Motivation: To challenge the assumption that the order of exceptional points is limited by the degrees of freedom in non-Hermitian systems.

Method: Theoretical analysis of non-Hermitian systems with non-Markovian effects, demonstrating how energy exchange with a reservoir leads to higher-order exceptional points.

Result: Showed that non-Markovian dynamics can induce higher-order exceptional points, observable via specific time intervals.

Conclusion: Non-Markovian effects enable the observation of higher-order exceptional points beyond the system's degrees of freedom, achieved through time-dependent dynamics involving exponential and polynomial functions.
...
### [42] [Quantum Gradient Flow Algorithm for Symmetric Positive Definite Systems via Quantum Eigenvalue Transformation: Towards Quantum CAE](https://arxiv.org/abs/2512.09623)
*Yuto Lewis Terashima,Tadashi Kadowaki,Yohichi Suzuki,Mayu Muramatsu,Katsuhiro Endo*

Main category: quant-ph

TL;DR: QGFA, a quantum gradient flow algorithm, efficiently solves SPD linear systems with faster convergence and lower errors compared to QMIA, validated on FEM problems.


<details>
  <summary>Details</summary>
Motivation: To address the computational inefficiency of quantum linear solvers like QMIA with increasing condition numbers, and inspired by classical SPD solvers' fast convergence.

Method: QGFA solves SPD linear systems through the gradient-flow process of the corresponding quadratic energy functional, validated by its application to FEM for linear elastic problems.

Result: QGFA achieves lower relative errors and faster convergence than QMIA when initialized with suitable initial states, demonstrating accurate convergence toward classical FEM solutions.

Conclusion: The proposed QGFA framework offers a physically interpretable connection between classical iterative solvers and quantum computational paradigms, demonstrating its potential for future developments in Quantum CAE.
...
### [43] [Geometric Origin of Quantum Entanglement](https://arxiv.org/abs/2512.09640)
*Marco Zaopo*
...
### [44] [Optyx: A ZX-based Python library for networked quantum architectures](https://arxiv.org/abs/2512.09648)
...
### [45] [Entanglement with a mode observable via a tunable interaction with a qubit](https://arxiv.org/abs/2512.09658)
*Małgorzata Strzałka,Radim Filip,Katarzyna Roszak*

Main category: quant-ph

TL;DR: Detection of spin-boson entanglement via tunable qubit-environment coupling, demonstrated with a superconducting transmon qubit, overcoming previous limitations.


<details>
  <summary>Details</summary>
Motivation: Existing methods for detecting spin-boson entanglement fail due to fixed system-environment interactions and inherent symmetries. This study explores the potential of tunable interactions, motivated by the need for practical entanglement detection in quantum systems.

Method: The research leverages tunable qubit-environment coupling (exemplified by a superconducting transmon qubit interacting with a microwave cavity) to design Hamiltonian parameters for preparing and measuring entanglement, circumventing inherent symmetries that previously hindered detection.

Result: The proposed scheme successfully detects spin-boson entanglement through qubit-only measurements, with a nonnegligibly large signal observed at finite temperatures.

Conclusion: The study demonstrates that qubit-only measurements can detect spin-boson entanglement, overcoming limitations of previous schemes by utilizing tunable qubit-environment coupling. Practical implementation with a superconducting transmon qubit shows feasibility even at finite temperatures.
...
### [46] [Pattern Based Quantum Key Distribution using the five qubit perfect code for eavesdropper detection](https://arxiv.org/abs/2512.09672)
*Mehedi Hasan Rumi*
...
### [47] [Device Independent Quantum Secret Sharing Using Multiparty Pseudo-telepathy Game](https://arxiv.org/abs/2512.09699)
...
### [48] [Dynamic stimulated emission for deterministic addition and subtraction of propagating photons](https://arxiv.org/abs/2512.09711)
...
### [49] [Quantum random number generation from the continuous variable payload for the SPOQC mission](https://arxiv.org/abs/2512.09716)
...
### [50] [Quantumness certification via non-demolition measurements](https://arxiv.org/abs/2512.09734)
...
### [51] [Rotational excitation of molecules in the regime of strong ro-vibrational coupling: Comparison between an optical centrifuge and a transform-limited pulse](https://arxiv.org/abs/2512.09746)
*J. M. García-Garrido,V. Milner,C. P. Koch,R. González-Férez*

Main category: quant-ph

TL;DR: Optical centrifuges control molecular rotation with minimal vibrational spread, outperforming Gaussian pulses.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of optical centrifuges in controlling molecular rotation when traditional rigid-rotor approximations are no longer valid.

Method: Theoretical investigation of molecular rotation under the influence of an optical centrifuge, focusing on the breakdown of the rigid-rotor approximation due to vibrational-rotational coupling.

Result: The optical centrifuge successfully excites high rotational states while limiting vibrational spread, unlike linearly polarized Gaussian pulses which cause significant vibrational broadening.

Conclusion: The optical centrifuge is an effective tool for controlled excitation of high rotational states with minimal vibrational spread, outperforming linearly polarized Gaussian pulses in this regard.
...
### [52] [Optimal certification of constant-local Hamiltonians](https://arxiv.org/abs/2512.09778)
...
### [53] [Pinball: A Cryogenic Predecoder for Quantum Error Correction Decoding Under Circuit-Level Noise](https://arxiv.org/abs/2512.09807)
...
### [54] [Quantum Algorithm for Estimating Ollivier-Ricci Curvature](https://arxiv.org/abs/2512.09822)
...
### [55] [Transpiling quantum circuits by a transformers-based algorithm](https://arxiv.org/abs/2512.09834)
...
### [56] [Practical and Efficient Verification of Entanglement with Incomplete Measurement Settings](https://arxiv.org/abs/2512.09856)
...
TL;DR: A framework for verifying entangled states with incomplete measurements, using an optimization approach to find effective entanglement witnesses and validated experimentally with photon-polarization qubits.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of verifying entangled states when only a tomographically incomplete measurement setting is available, particularly when access to observables is severely limited.

Method: Introduces an optimization approach formulated as a semidefinite program to systematically search for the best entanglement witnesses under limited measurement constraints.

Result: A practical framework is presented for efficiently identifying entangled states by constructing a large family of entanglement witnesses from a small number of observables.

Conclusion: The results demonstrate the maximal usefulness of incomplete measurement settings for entanglement verification in realistic scenarios, as validated by the proof-of-principle experiment with photon-polarization qubits.
...
### [57] [True Random Number Generators on IQM Spark](https://arxiv.org/abs/2512.09862)
*Andrzej Gnatowski,Jarosław Rudy,Teodor Niżyński,Krzysztof Święcicki*

Main category: quant-ph

TL;DR: A study on TRNG using Odra 5 quantum computer, testing 5 circuits with 105 variants, validates randomness quality via NIST tests, addressing gaps in existing research.


<details>
  <summary>Details</summary>
Motivation: To address gaps in existing studies by examining TRNG circuits on a real-life quantum computer (Odra 5) beyond IBM systems, utilizing the IQM superconducting architecture, and providing a thorough literature review.

Method: The research involves testing 5 types of TRNG circuits with 105 subvariants on the Odra 5 quantum computer, generating 1 million bits per circuit. The randomness quality is evaluated using NIST SP 800-22 and NIST SP 800-90B test suites.

Result: The study validates the effectiveness of TRNG circuits on Odra 5, demonstrating high-quality randomness through NIST test suites, and highlights the potential of quantum computers for TRNG.

Conclusion: The study successfully demonstrates the feasibility of using the Odra 5 quantum computer for True Random Number Generation (TRNG), providing a comprehensive analysis of multiple circuit types and their variants. The results validate the quality of randomness using standardized NIST tests.
...
### [58] [Error Mitigation of Fault-Tolerant Quantum Circuits with Soft Information](https://arxiv.org/abs/2512.09863)
...
### [59] [A 0.8395-approximation algorithm for the EPR problem](https://arxiv.org/abs/2512.09896)
*Anuj Apte,Eunou Lee,Kunal Marwaha,Ojas Parekh,Lennart Sinjorgo,James Sud*

Main category: quant-ph

TL;DR: A 0.8395-approximation algorithm for the EPR Hamiltonian, using new entanglement bounds and refined circuit parameters, with limitations on further improvements using current methods.


<details>
  <summary>Details</summary>
Motivation: To efficiently approximate the EPR Hamiltonian with an improved ratio.

Method: A new nonlinear monogamy-of-entanglement bound on star graphs and a refined parameterization of a shallow quantum circuit from previous works.

Result: An efficient 0.8395-approximation algorithm for the EPR Hamiltonian is achieved.

Conclusion: Further progress in improving the approximation ratio for the EPR Hamiltonian will require fundamentally new techniques, as current methods have limitations.
...
### [60] [Two simple models derived from a quantum-mechanical particle on an elliptical path](https://arxiv.org/abs/2512.09905)
...
### [61] [Gate-Tunable Superconducting Spin Valve in a van der Waals Ferromagnet/Superconductor/Ferromagnet Trilayer](https://arxiv.org/abs/2512.09093)
*A. S. Ianovskaia,G. A. Bobkov,A. M. Bobkov,I. V. Bobkova*

Main category: cond-mat.supr-con

TL;DR: A van der Waals F/S/F heterostructure shows gate-tunable superconducting spin valve effects and unconventional superconducting behaviors, enabling versatile spintronic applications.


<details>
  <summary>Details</summary>
Motivation: To explore gate-tunable superconducting spin valve effects and unconventional superconducting states in van der Waals heterostructures for advanced superconducting spintronics applications.

Method: The study involves theoretical demonstration and electrostatic gating of a van der Waals heterostructure composed of a superconducting monolayer sandwiched between two ferromagnetic monolayers.

Result: The system can be continuously tuned between standard, inverse, and triplet spin valve regimes, with the emergence of non-BCS temperature dependencies, reentrant superconductivity, bistable states, and first-order phase transitions.

Conclusion: The results establish van der Waals F/S/F trilayers as a highly controllable platform for superconducting spintronics, enabling selective activation of different spin-valve functionalities and unconventional superconducting states through external gate voltages.
...
### [62] [Bulk superconductivity in the kagome metal YRu3B2](https://arxiv.org/abs/2512.09314)
...
### [63] [Influence of strong electron irradiation on fluctuation conductivity and pseudogap in YBa$_2$Cu$_3$O$_7$--$δ$ single crystals](https://arxiv.org/abs/2512.09533)
*A. L. Solovjov,K. Rogacki,N. V. Shytov,E. V. Petrenko,L. V. Bludova,A. Chroneos,R. V. Vovk*

Main category: cond-mat.supr-con

TL;DR: High-energy electron irradiation alters YBCO's resistivity, superconductivity, and pseudogap, with distinct effects at different doses. A crossover at $φ_3$ marks significant changes, while higher doses surprisingly restore pristine-like behavior.


<details>
  <summary>Details</summary>
Motivation: To understand how defects introduced by high-energy electron irradiation affect the superconducting and pseudogap properties of YBCO, particularly focusing on the transitions between different theoretical regimes (AG and EK).

Method: The researchers investigated the effects of high-energy electron irradiation on YBCO single crystals, analyzing resistivity, fluctuation conductivity, and pseudogap behavior. They studied the changes in these properties as a function of irradiation dose.

Result: Irradiation linearly increases resistivity and reduces $T_c$. The AG--EK crossover at $φ_3$ leads to sharp changes in interplane spacing, coherence length, and fluctuation region. Pseudogap parameters rise sharply at $φ_3$ but decrease with further irradiation. Surprisingly, at a higher dose ($φ_5$), the system reverts to behavior resembling pristine YBCO.

Conclusion: The study reveals complex responses of YBCO single crystals to high-energy electron irradiation, showing distinct regimes of behavior based on irradiation dose. The AG--EK crossover and subsequent changes in material properties highlight the interplay between defects and superconducting phenomena.
...
### [64] [Checkerboard-type Zhang-Rice States in Overdoped Cuprate Superconductors](https://arxiv.org/abs/2512.09547)
...
### [65] [Study of fluctuation conductivity in YBa$_2$Cu$_3$O$_7$--$δ$ films in strong magnetic fields](https://arxiv.org/abs/2512.09550)
*E. V. Petrenko,L. V. Omelchenko,Yu. A. Kolesnichenko,N. V. Shytov,K. Rogacki,D. M. Sergeyev,A. L. Solovjov*

Main category: cond-mat.supr-con

TL;DR: Magnetic field effects on YBCO films show suppression of MT term at 3T, leading to 2D vortex lattice behavior and unusual coherence length trends.


<details>
  <summary>Details</summary>
Motivation: To investigate the impact of magnetic fields on the superconducting properties of YBCO thin films, particularly fluctuation conductivity and coherence length.

Method: Analysis of resistivity and fluctuation conductivity under varying magnetic fields up to 8T, with focus on crossover behaviors and suppression effects.

Result: At B=3T, the Maki--Thompson term is suppressed, and fluctuation conductivity follows 2D AL theory, suggesting 2D vortex lattice formation. Unusual dependencies in coherence length and fluctuation range are observed above 3T.

Conclusion: The results demonstrate the possibility of vortex state formation in YBCO thin films and its evolution with increasing magnetic field, revealing unusual behaviors in coherence length and fluctuation conductivity.
...
### [66] [Evolution of the pseudogap and excess conductivity of YBa$_2$Cu$_3$O$_{7-δ}$ single crystals in the course of long-term aging](https://arxiv.org/abs/2512.09789)
...
### [67] [Superconductivity and geometric superfluid weight of a tunable flat band system](https://arxiv.org/abs/2512.09901)
*M. A. Mojarro,Sergio E. Ulloa*

Main category: cond-mat.supr-con

TL;DR: The α-𝒯₃ lattice model's quasi-flat band exhibits tunable superconductivity and superfluid weight, with enhanced quantum geometry effects near half-filling.


<details>
  <summary>Details</summary>
Motivation: To study superconductivity and superfluid weight in the two-dimensional α-𝒯₃ lattice with on-site asymmetries, focusing on the isolated quasi-flat band's tunable properties.

Method: Mean-field approximation of the attractive Hubbard model and linear response theory.

Result: Superconducting order parameters depend strongly on α, interaction strength, and electron filling. A superconducting gap opens with power-law growth, and the superfluid weight's geometric contribution grows linearly for small interactions. Tuning α enhances the quantum metric and superfluid weight, especially near half-filling.

Conclusion: The α-𝒯₃ lattice model is established as a tunable system for studying quantum geometry and superfluid weight, with potential applications in related quantum materials.
...
### [68] [On modeling quantum point contacts in quantum Hall systems](https://arxiv.org/abs/2512.09045)
...
### [69] [Orbital magnetization from parallel transport of Bloch states](https://arxiv.org/abs/2512.09051)
*Johannes Mitscherling,Jan Priessnitz,Libor Šmejkal*

Main category: cond-mat.mes-hall

TL;DR: The paper introduces a new quantum geometric building block, the band-resolved adiabatic connection operator, to reformulate orbital magnetic moments and address limitations in existing formulas, demonstrating its utility in a specific magnet system.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the limitations of existing quantum geometric formulations, particularly the noncommutativity between band projectors and their momentum derivatives, and to extend the applicability to degenerate bands.

Method: The paper employs a quantum geometric approach, introducing a band-resolved adiabatic connection operator as a second building block for quantum geometry. This operator is used to reformulate expressions for the band-resolved orbital magnetic moment and to separate energetic and quantum-state properties.

Result: The result includes a reformulated expression for the band-resolved orbital magnetic moment and a demonstration of large orbital magnetization in a spin-compensated, noncoplanar anomalous Hall magnet without spin-orbit coupling.

Conclusion: The paper concludes that the newly identified band-resolved adiabatic connection operator provides a complementary geometric interpretation for quantum geometry, enabling the formulation of expressions valid for both nondegenerate and degenerate bands, thus overcoming the limitations of existing Bloch-state formulas. The theory is demonstrated through the calculation of orbital magnetization in a specific spin-compensated, noncoplanar anomalous Hall magnet.
...
### [70] [Electronic structure of InP/ZnSe quantum dots: effect of tetrahedral shape, valence band coupling and excitonic interactions](https://arxiv.org/abs/2512.09156)
...
### [71] [Symmetry-resolved magnetoelastoresistance in multivalley bismuth](https://arxiv.org/abs/2512.09211)
...
### [72] [Skyrmion Sliding Switch in a 90-nm-Wide Nanostructured Chiral Magnet](https://arxiv.org/abs/2512.09225)
...
### [73] [Current-controlled creations, deletions, and topological transformations of a single magnetic antiskyrmion in nanostructured cells](https://arxiv.org/abs/2512.09228)
*Yaodong Wu,Jialiang Jiang,Lingyao Kong,Wei Liu,Huanhuan Zhang,Shouguo Wang,Mingliang Tian,Haifeng Du,Jin Tang*

Main category: cond-mat.mes-hall

TL;DR: Electrical manipulation of single antiskyrmions is demonstrated in nanostructured cells, enabling reversible creation, deletion, and topological transformations, with potential for spintronic devices.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of electrically manipulating single antiskyrmions, which is crucial for fundamental device applications.

Method: The study involves nanostructured FeNiPdP cells (400 nm in width and length) and uses nanosecond single-pulsed currents to manipulate single antiskyrmions. Micromagnetic simulations are employed to corroborate the results.

Result: The researchers achieved reversible creation, deletion, and topological transformations of single antiskyrmions at room temperature, including transitions among antiskyrmions, skyrmions, bubbles, and ferromagnetic states.

Conclusion: The experimental findings demonstrate the potential for advancing antiskyrmion-based device applications through current-controlled manipulations.
...
### [74] [Creating and Deleting a Single Dipolar Skyrmion by Surface Spin Twists](https://arxiv.org/abs/2512.09229)
...
TL;DR: Deterministic skyrmion operations in nanostructured cuboids via in-plane currents, enabling reliable single-bit operations for memory applications.


<details>
  <summary>Details</summary>
Motivation: The motivation is to develop a reliable method for deterministic operations on single dipolar skyrmions for applications like random-access memories, avoiding the need for artificial defects or pinning sites.

Method: The research employs in-plane currents to manipulate single dipolar skyrmions in nanostructured cuboids, leveraging spin-transfer torque and magnetic dipole-dipole interactions, with results verified through 3D micromagnetic simulations.

Result: Highly reversible writing and deleting of skyrmions are achieved in simple cuboids, with creation explained by spin-transfer torque and deletion by magnetic hysteresis and Joule heating.

Conclusion: The study demonstrates a viable method for reliable single-bit operations in skyrmionic devices using deterministic current-induced skyrmion writing and deleting in nanostructured cuboids, validated by 3D micromagnetic simulations.
...
### [75] [Modeling the dynamics of trapped electrons in quantum dots](https://arxiv.org/abs/2512.09470)
*R. Carmina Monreal*

Main category: cond-mat.mes-hall

TL;DR: A study on electron dynamics in quantum dots reveals transient and quasi-stationary behaviors, with implications for light emission statistics and experimental observations in ZnO nanoparticles.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics of electron occupancies and light emission in a quantum dot system under the influence of electron-electron and electron-phonon interactions, and to explain experimental observations in ZnO nanoparticles.

Method: A numerically exact solution for a simple model analyzing electron-electron and electron-phonon interactions in a quantum dot system, focusing on time evolution of electron occupancies and statistical factors for light emission.

Result: The system dynamics exhibits a short transient phase followed by a quasi-stationary regime. Strong electronic correlations are observed for negative Coulomb interaction, but these do not affect light emission statistics. Light emission is generally possible except in cases where the valence band is initially filled with two electrons, leading to negligible exciton emission.

Conclusion: The study provides a potential explanation for the observed experimental behavior of ZnO nanoparticles under continuous ultraviolet illumination, linking the dynamics of electron occupancies and light emission statistics to the phenomena.
...
### [76] [Controlling Skyrmion Lattices via Strain: Elongation, Tilting, and Collapse Mechanisms](https://arxiv.org/abs/2512.09518)
...
### [77] [Kerr effect induced by exchange interaction of electrons separated by a tunnel barrier in a double quantum well](https://arxiv.org/abs/2512.09541)
...
### [78] [Unconventional bright ground-state excitons in monolayer TiI$_2$ from first-principles calculations](https://arxiv.org/abs/2512.09602)
*Franz Fischer,Carl Emil Mørch Nielsen,Marta Prada,Gabriel Bester*

Main category: cond-mat.mes-hall

TL;DR: TiI$_2$ has a bright exciton ground state due to unique spin-orbit and exchange interactions, stable under strain and inherited by trions, promising for fast radiative applications.


<details>
  <summary>Details</summary>
Motivation: The motivation is to understand and identify the mechanisms leading to a bright exciton ground state in TiI$_2$, which is unprecedented among transition metal dichalcogenides.

Method: The research employs _ab initio_ screened configuration interaction calculations to analyze TiI$_2$.

Result: The results reveal two key mechanisms: spin-orbit induced conduction band splitting and weak exchange interaction, which together ensure the bright exciton ground state. Additionally, the bright exciton is stable under mechanical strains and inherited by trion states.

Conclusion: The study concludes that TiI$_2$ exhibits a bright exciton ground state due to unique spin-orbit and exchange interaction mechanisms, and this phenomenon is stable under mechanical strains and inherited by trion states.
...
### [79] [Non-Hermitian trapping of Dirac exciton-polariton condensates in a perovskite metasurface](https://arxiv.org/abs/2512.09603)
...
### [80] [Domain Wall Control of Topological Qubits in the Kitaev SSH Chain](https://arxiv.org/abs/2512.09693)
*Griffith Rufo,Sabrina Rufo,Heron Caldas*

Main category: cond-mat.mes-hall

TL;DR: Introduction of domain walls in anisotropic superconducting chains provides a robust and simple method to control topological qubits, reframing defects as useful quantum resources.


<details>
  <summary>Details</summary>
Motivation: To explore a robust and simple mechanism for controlling topological qubits by leveraging defects rather than fine-tuning global parameters.

Method: Introducing a domain wall into a chain with anisotropic superconducting correlations to control zero energy states and boundary modes.

Result: Demonstrates that a domain wall can act as a digital knob to control the parity of zero modes, enabling the existence of isolated Majorana states at chain ends.

Conclusion: The study reframes defects as useful resources for quantum information and computation, highlighting their role in controlling topological qubits through domain walls.
...
### [81] [Reinterpreting Landauer conductance, solving the quantum measurement problem, grand unification](https://arxiv.org/abs/2512.09709)
