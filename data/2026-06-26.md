...
### [10] [The fate of odd-parity magnetism in one dimension](https://arxiv.org/abs/2606.26222)
...
### [11] [Toric code made subsystem: a framework for topological subsystem codes using anticommuting quantum spin liquids](https://arxiv.org/abs/2606.26226)
...
### [12] [Bobkingite, a new coupled sawtooth chain platform](https://arxiv.org/abs/2606.26243)
...
### [13] [Odd-parity electronic order near the semiconductor limit](https://arxiv.org/abs/2606.26338)
...
### [14] [Coexistence of static order and spin dynamics in an S = 5/2 frustrated triangular antiferromagnet](https://arxiv.org/abs/2606.26921)
...
### [15] [Finite temperature precursors of Mottness in the Fermi Hubbard model](https://arxiv.org/abs/2606.27204)
...
### [16] [Hidden-ordered Dirac fermions](https://arxiv.org/abs/2606.27368)
*Bitan Roy*
...
### [17] [Dissipative Quantum Multiplicative Weights with Sampling Feedback: A Classically Hard Primitive Realized via Engineered Open-System Dynamics](https://arxiv.org/abs/2606.26162)
...
### [18] [Criterion for qubit-assisted quantum metrology approaching Heisenberg scaling](https://arxiv.org/abs/2606.26167)
*Peng Chen,Jun Jing*
...
### [19] [Measures of Chirality in Mixed-State Topological Phases](https://arxiv.org/abs/2606.26235)
...
### [20] [Interpretable rule-based learning in an autonomous thermodynamic network](https://arxiv.org/abs/2606.26220)
...
### [21] [Optimal observables for quantum-enhanced sensing and applications in a Floquet time crystal sensor](https://arxiv.org/abs/2606.26248)
...
### [22] [A fidelity metric for quantum annealing benchmarked by extreme scaling quantum Monte-Carlo simulations](https://arxiv.org/abs/2606.26233)
...
### [23] [Dissipation-Induced Deviations from Kibble-Zurek Scaling in Non-Hermitian Quantum Annealing](https://arxiv.org/abs/2606.26870)
...
### [24] [Permutation asymmetry unlocks emergent advantage in randomized Bell tests](https://arxiv.org/abs/2606.26242)
...
### [26] [A Survey of Quantum Programming Languages](https://arxiv.org/abs/2606.26254)
...
### [27] [Complex frequency-dependent quadrature squeezing in semiconductor lasers](https://arxiv.org/abs/2606.26266)
...
### [28] [Mechanisms governing photon-pair generation and emission directionality in quantum metasurfaces](https://arxiv.org/abs/2606.26303)
...
### [29] [Tailor Made Embeddings for Quantum Machine Learning](https://arxiv.org/abs/2606.26312)
...
### [30] [Improving device-independent quantum key distribution protocols through multiple routed Bell tests](https://arxiv.org/abs/2606.26329)
...
### [31] [Equivalence of non-local computation tasks beyond Clifford operations](https://arxiv.org/abs/2606.26354)
...
### [32] [Algebraic structures of the Lindblad equation](https://arxiv.org/abs/2606.26477)
...
### [33] [Non-Hermitian Bloch Oscillations](https://arxiv.org/abs/2606.26480)
...
### [34] [Scattering theory for cavity-assisted spin-motion-photon interactions](https://arxiv.org/abs/2606.26542)
...
### [35] [Graph Structures for Local Distinguishability of Quantum Product States](https://arxiv.org/abs/2606.26558)
...
### [36] [Quantum Fast-Forwarding Beyond Reversibility: The $α$-Perturbed $n$-Cycle](https://arxiv.org/abs/2606.26584)
...
### [37] [Non-Hermiticity of an anomalous superradiant phase](https://arxiv.org/abs/2606.26770)
...
### [38] [Nonadiabatic Holonomic Single-Qubit Gates in Non-Hermitian Systems](https://arxiv.org/abs/2606.26798)
...
### [39] [Scalable Message-Passing Quantum Graph Neural Networks in the Weisfeiler-Leman Hierarchy](https://arxiv.org/abs/2606.26873)
...
### [40] [Shallow Quantum Circuits for Deep Chemistry via Valence Bond Embeddings](https://arxiv.org/abs/2606.26882)
...
### [41] [An ultralow-loss integrated photonic platform for discrete-variable quantum information processing](https://arxiv.org/abs/2606.26910)
...
### [42] [On the simple derivation of the Casimir effect](https://arxiv.org/abs/2606.26946)
...
### [43] [Lattice patch structure for fixed-frequency transmon quantum computer with high-fidelity CNOT gates](https://arxiv.org/abs/2606.27017)
...
### [44] [Witness expansion: A unified framework for analytical and measurable mixed-state resource detection](https://arxiv.org/abs/2606.27105)
...
### [45] [Efficient foundation decoders for fault-tolerant quantum computing](https://arxiv.org/abs/2606.27119)
...
### [46] [Rate-2/3 Girth-8 (3,18)-Regular Quantum LDPC Codes from Two-Branch Finite-Field Bases and CPM Lifts](https://arxiv.org/abs/2606.27130)
...
### [47] [Loss-aware pulse sequence optimization for generating photonic Fock states](https://arxiv.org/abs/2606.27158)
...
### [48] [From Approximate Floquet Engineering to Full Floquet Theory: Coherent Control of Chiral Spin Systems in Spintronics](https://arxiv.org/abs/2606.27183)
...
### [49] [Quantum group codes for non-Clifford logic: enhanced decoding, addressability and parallelizability](https://arxiv.org/abs/2606.27211)
...
### [50] [A 0.651-approximation to quantum Max Cut via Rydberg atoms](https://arxiv.org/abs/2606.27224)
...
### [51] [A hardware-safety-gated system for LLM-written native ARTIQ control code on a trapped-ion platform](https://arxiv.org/abs/2606.27231)
...
### [52] [Quantum computer architecture with ions in tweezer arrays](https://arxiv.org/abs/2606.27249)
...
### [53] [Particle-preserving fermionic shadows with mode-independent sample complexity](https://arxiv.org/abs/2606.27254)
...
### [54] [Large-scale multimode entangling-gate synthesis in trapped-ion systems](https://arxiv.org/abs/2606.27266)
...
### [55] [Quantum-Limited Subdiffraction Telescopy Requires Genuine Multi-Telescope Interference](https://arxiv.org/abs/2606.27276)
...
### [56] [Self-Sifting quantum key distribution](https://arxiv.org/abs/2606.27299)
...
### [57] [Cultivating logical catalysts for fault-tolerant dyadic phase rotations](https://arxiv.org/abs/2606.27358)
*Yichen Xu,Xiao Wang*
...
### [58] [Anomalous Hall viscosity of altermagnets](https://arxiv.org/abs/2606.26239)
...
### [59] [Quantum Hall effect in three-dimensional lattice induced by Wannier-Stark-Landau localization](https://arxiv.org/abs/2606.26444)
*D. -H. -Minh Nguyen*
...
### [60] [Photo-thermal origin of pulse laser induced orientation of crystallographic c axis in Tellurium thin films](https://arxiv.org/abs/2606.26499)
...
### [61] [Photon-Assisted Tunneling in Double Quantum Dot: Application of Scattering Theory](https://arxiv.org/abs/2606.26622)
...
### [63] [Floquet-Engineered Chern Insulator in two-dimensional $d_{x^2-y^2}$-Wave Altermagnets](https://arxiv.org/abs/2606.26632)
*Hosein Cheraghchi*
...
### [64] [Spin-orbit coupling driven topological superconductivity in twisted bilayer graphene-WSe$_2$ heterostructures](https://arxiv.org/abs/2606.27013)
...
### [65] [Floquet Topological Phases and Anomalous Hall Signatures in Irradiated Two-dimensional $d_{xy}$-Wave Altermagnets](https://arxiv.org/abs/2606.26667)
*Hosein Cheraghchi*
...
### [66] [Perfect Absorption in the Strong Coupling Regime via Degenerate Critical Coupling](https://arxiv.org/abs/2606.26708)
...
### [67] [Rashba and Electrostatic Control of Charge-Visible Spin Demons in Two-Dimensional d-Wave Altermagnets](https://arxiv.org/abs/2606.26871)
...
### [68] [Low-energy model for doped graphene nanoribbons](https://arxiv.org/abs/2606.27102)
...
### [69] [Magnetoresistance in chiral systems driven by inter-band spin-orbit coupling](https://arxiv.org/abs/2606.27121)
...
### [70] [Phase-Shifted Planar Hall and Magnetoresistive Responses in Weyl Semimetals](https://arxiv.org/abs/2606.27167)
...
### [71] [Strong coupling between propagating spin wave and microwave photons in a superconducting resonator](https://arxiv.org/abs/2606.27279)
...
### [72] [Specific absorption rate of uniaxial single-domain nanomagnets: stochastic spin dynamics versus linear response theory](https://arxiv.org/abs/2606.27351)
*H. Kachkachi*
...
### [73] [Dirac fermions in non-Hermitian magnetic fields: Zero modes and index theorem](https://arxiv.org/abs/2606.27370)
