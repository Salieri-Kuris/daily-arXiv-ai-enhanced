...
### [1] [Fluctuation-Response Theory for Nonequilibrium Langevin Dynamics](https://arxiv.org/abs/2601.16387)
...
### [2] [Active Cahn--Hilliard theory for non-equilibrium phase separation: quantitative macroscopic predictions and a microscopic derivation](https://arxiv.org/abs/2601.16539)
...
### [3] [What is nonequilibrium?](https://arxiv.org/abs/2601.16716)
*Christian Maes*
...
### [4] [Statistical mechanics of a 2D material in a gas reservoir](https://arxiv.org/abs/2601.16856)
...
### [5] [Universal classical and quantum fluctuations in the large deviations of current of noisy quantum systems: The case of QSSEP and QSSIP](https://arxiv.org/abs/2601.16883)
...
### [6] [Superconductivity in non-centrosymmetric rhombohedral NbSe2](https://arxiv.org/abs/2601.16475)
...
### [7] [Pressure-induced superconductivity in topological insulator Ge2Bi2Te5 and the evolution with Mn doping](https://arxiv.org/abs/2601.16831)
...
### [8] [Superconducting density of states and vortex lattice of LaRu$_2$P$_2$ observed by Scanning Tunneling Spectroscopy](https://arxiv.org/abs/2601.16843)
...
### [9] [Reducing TLS loss in tantalum CPW resonators using titanium sacrificial layers](https://arxiv.org/abs/2601.16369)
...
### [10] [LiDMaS: Architecture-Level Modeling of Fault-Tolerant Magic-State Injection in GKP Photonic Qubits](https://arxiv.org/abs/2601.16244)
...
### [11] [Quantum Cellular Automata on a Dual-Species Rydberg Processor](https://arxiv.org/abs/2601.16257)
...
### [12] [Multi-invariants in stabilizer states](https://arxiv.org/abs/2601.16258)
...
### [13] [Quantum algorithm for simulating non-adiabatic dynamics at metallic surfaces](https://arxiv.org/abs/2601.16264)
...
### [14] [Post-processing optimization and optimal bounds for non-adaptive shadow tomography](https://arxiv.org/abs/2601.16266)
...
### [15] [Engineering Near-Infrared Two-Level Systems in Confined Alkali Vapors](https://arxiv.org/abs/2601.16269)
...
### [17] [Experimental observation of conformal field theory spectra](https://arxiv.org/abs/2601.16275)
...
### [18] [Exploring Noisy Quantum Thermodynamical Processes via the Depolarizing-Channel Approximation](https://arxiv.org/abs/2601.16317)
...
### [19] [Unambiguous randomness from a quantum state](https://arxiv.org/abs/2601.16343)
*Fionnuala Curran*
...
### [23] [Quantum phase estimation with optimal confidence interval using three control qubits](https://arxiv.org/abs/2601.16474)
...
### [24] [Indefinite Causal Order from Failure-to-Glue: Contextual Semantics and Parametric Time](https://arxiv.org/abs/2601.16494)
*Partha Ghose*
...
### [34] [SeeMPS: A Python-based Matrix Product State and Tensor Train Library](https://arxiv.org/abs/2601.16734)
...
### [35] [Noise Resilience and Robust Convergence Guarantees for the Variational Quantum Eigensolver](https://arxiv.org/abs/2601.16758)
...
### [36] [Investigating Retargetability Claims for Quantum Compilers](https://arxiv.org/abs/2601.16779)
...
### [37] [Harnessing Quantum Computing for Energy Materials: Opportunities and Challenges](https://arxiv.org/abs/2601.16816)
...
### [38] [Protocols to share genuine multipartite entanglement employing copies of biseparable states](https://arxiv.org/abs/2601.16840)
...
### [39] [Generation of fully phase controlled two-photon entangled states](https://arxiv.org/abs/2601.16875)
...
### [40] [Quantum Position Verification with Remote Untrusted Devices](https://arxiv.org/abs/2601.16892)
...
### [41] [Upper bounds on the purity of Wigner positive quantum states that verify the Wigner entropy conjecture](https://arxiv.org/abs/2601.16898)
...
### [42] [Quantum Fisher information analysis for absorption measurements with undetected photons](https://arxiv.org/abs/2601.16941)
...
### [43] [Experimental investigation of nonclassicality in the simplest scenario via the degrees of freedom of light](https://arxiv.org/abs/2601.16952)
...
### [44] [Engineering discrete local dynamics in globally driven dual-species atom arrays](https://arxiv.org/abs/2601.16961)
...
### [45] [Autonomous Optical Alignment of Satellite-Based Entanglement Sources using Reinforcement Learning](https://arxiv.org/abs/2601.16968)
...
### [46] [Formalising an operational continuum limit of quantum combs](https://arxiv.org/abs/2601.16974)
...
### [47] [A comprehensive semi-automated fabrication system for quartz tuning fork AFM probe with real-time resonance frequency monitoring and Q-factor control](https://arxiv.org/abs/2601.16221)
...
### [48] [Synergy of fivefold boost SOT efficiency and field-free magnetization switching with broken inversion symmetry: Toward neuromorphic computing](https://arxiv.org/abs/2601.16222)
...
### [49] [Multistability of graphene nanobubbles](https://arxiv.org/abs/2601.16300)
*Alexander V. Savin*
...
### [50] [A modified Lindblad equation for a Rabi driven electron-spin qubit with tunneling to a Markovian lead](https://arxiv.org/abs/2601.16306)
...
### [51] [Optical probing of Wigner crystallization in monolayer WSe$_2$ via diffraction of longitudinal excitons](https://arxiv.org/abs/2601.16319)
...
### [52] [Diffusive and hydrodynamic magnetotransport around a density perturbation in a two-dimensional electron gas](https://arxiv.org/abs/2601.16402)
...
### [53] [Distinguishing Hot-Electron and Optomechanical Pathways at Metal-Molecule Interfaces](https://arxiv.org/abs/2601.16445)
...
### [54] [A low-tech solution to process entire metal/molecule heterostructure stacks into vertical nanopillar electronic devices](https://arxiv.org/abs/2601.16481)
...
### [55] [The 2026 Skyrmionics Roadmap](https://arxiv.org/abs/2601.16575)
...
### [56] [Enhanced Terahertz Photoresponse via Acoustic Plasmon Cavity Resonances in Scalable Graphene](https://arxiv.org/abs/2601.16604)
...
### [57] [Current-induced magnetization control in dipolar-coupled nanomagnet pairs and artificial spin ice](https://arxiv.org/abs/2601.16633)
...
### [58] [Observation of an isolated flat band in the van der Waals crystal NbOCl$_2$](https://arxiv.org/abs/2601.16688)
...
### [59] [Twisted bilayer graphene from first-principles: structural and electronic properties](https://arxiv.org/abs/2601.16851)
...
### [60] [Magnetosomes in Nature, Biomedicine and Physics](https://arxiv.org/abs/2601.16861)
*N. A. Usov*
...
### [61] [Interaction Induced Magnetotransport in a 2D Dirac-Heavy Hole Hybrid Band System](https://arxiv.org/abs/2601.16864)
...
### [63] [Doping-dependent orbital magnetism in Chromium pnictides](https://arxiv.org/abs/2601.16908)
...
### [64] [Ab Initio Many Body Quantum Embedding and Local Correlation in Crystalline Materials using Interpolative Separable Density Fitting](https://arxiv.org/abs/2601.16379)
...
### [65] [Emergence of Kondo-assisted Néel order in a Kondo necklace model](https://arxiv.org/abs/2601.16388)
...
### [66] [Realization of a triangular spin necklace in a verdazyl-based Ni complex](https://arxiv.org/abs/2601.16389)
...
### [67] [Accelerating dynamical mean-field theory convergence by preconditioning with computationally cheaper quantum embedding methods](https://arxiv.org/abs/2601.16401)
...
### [68] [Effect of Electron Correlation on the Integer Quantum Hall Effect](https://arxiv.org/abs/2601.16453)
...
### [69] [Bosonization Solution to Spin-Valley Kondo Problem: Finite-Size Spectrum and Renormalization Group Analysis](https://arxiv.org/abs/2601.16525)
...
### [70] [$d$-wave FFLO state and charge-2e supersolidity in the $t$-$t'$-$J$ model under Zeeman fields](https://arxiv.org/abs/2601.16630)
...
### [71] [Zoology of Altermagnetic-type Non-collinear Magnets on the Maple Leaf Lattice](https://arxiv.org/abs/2601.16807)
...
### [72] [Non-Abelian fusion and braiding in many-body parton states](https://arxiv.org/abs/2601.16819)
*Koyena Bose*
...
### [73] [Intermediate Field Spin(on) Dynamics in $α$-RuCl$_3$](https://arxiv.org/abs/2601.16850)
...
### [74] [Boundary critical phenomena in the quantum Ashkin-Teller model](https://arxiv.org/abs/2601.16951)
