...
### [4] [Quantum Geometric Kondo Cloud](https://arxiv.org/abs/2608.14072)
...
### [6] [Chiral spin liquid and chiral antiferromagnetism in half-filled moiré Hubbard model: possible applications to twisted bilayer TMDs](https://arxiv.org/abs/2608.14503)
*Chuyi Tuo,Hong Yao*
...
### [13] [A Quantum Optimization Framework for Data-Assimilation-Augmented Parameter Estimation](https://arxiv.org/abs/2608.13614)
...
### [14] [A scalable edge-pass Purcell filter for high-fidelity readout of superconducting qubits](https://arxiv.org/abs/2608.13627)
...
### [15] [Heuristic Lookahead Distillation Protocol Search](https://arxiv.org/abs/2608.13644)
...
### [16] [Tracking real-space quantum state breathing through Floquet-projector geometry](https://arxiv.org/abs/2608.13649)
...
### [17] [Open system probes of renormalization group flow](https://arxiv.org/abs/2608.13664)
...
### [18] [Entanglement Negativity in Noisy Quantum Volume Sampling](https://arxiv.org/abs/2608.13654)
...
### [19] [Exchange-only qubit stabilized by a single-spin qubit](https://arxiv.org/abs/2608.14214)
...
### [20] [Efficient Hamiltonian Truncation: Fast Matrix Construction and Quantum Krylov Diagonalization](https://arxiv.org/abs/2608.13691)
...
### [21] [Scalable Test of Genuine Multipartite Entanglement via Partially Randomized Measurements](https://arxiv.org/abs/2608.13725)
...
### [22] [Nonorthogonal-state erasure as the resource behind apparent second-law violations](https://arxiv.org/abs/2608.13881)
...
### [23] [Designing robust molecular spins for quantum technologies with theoretical chemistry](https://arxiv.org/abs/2608.13744)
...
### [24] [Quantum Snapshots Reveal a Compact Conformal Boundary Mode](https://arxiv.org/abs/2608.14327)
*M. A. Rajabpour*
...
### [29] [de Broglie-Bohm Dynamics with Schrödinger Source Fields: A Framework for Subquantum Theory](https://arxiv.org/abs/2608.13894)
*Said Mikki*
...
### [30] [Robust Quantum Extremal Numbers](https://arxiv.org/abs/2608.13907)
...
### [31] [Maximizing Nonclassicality of Massive Objects via Quantum Zeno Effect](https://arxiv.org/abs/2608.13942)
...
### [32] [Neural decoders for subsystem many-hypercube codes](https://arxiv.org/abs/2608.13975)
...
### [33] [Limits of independent and identical measurements for quantum illumination with an unknown return phase](https://arxiv.org/abs/2608.13997)
...
### [34] [Circuit Depth Compression via Spectral Gap Amplification in Quantum Phase Estimation](https://arxiv.org/abs/2608.14002)
...
### [35] [Non-Abelian geometry and globally inequivalent symmetry reductions of the cylindrical Dirac doublet](https://arxiv.org/abs/2608.14041)
...
### [36] [Information-Calibrated Quantum Diffusion: Aligning Forward Noise with Reverse Recoverability](https://arxiv.org/abs/2608.14083)
...
### [37] [Entanglement certification via causal-order interferometry in a quantum switch](https://arxiv.org/abs/2608.14110)
...
### [38] [A groupoidal approach to quantum reference frames](https://arxiv.org/abs/2608.14133)
...
### [39] [Photonic Quantum Computing vs. Classical Solvers in Constrained Factor Portfolio Optimization](https://arxiv.org/abs/2608.14134)
...
### [40] [Classical Limits of Spectral Filtering in Quantum Generative Models](https://arxiv.org/abs/2608.14169)
*Marco Roth*
...
### [41] [The Organization of Environmental Coupling Shapes What Quantum Reservoirs Remember](https://arxiv.org/abs/2608.14181)
...
### [42] [Local geometry for Schmidt number witnesses](https://arxiv.org/abs/2608.14199)
...
### [43] [Synthesizing In-Bulk Topological Corner States via Giant Atoms](https://arxiv.org/abs/2608.14206)
...
### [44] [Foundation Neural Effective Hamiltonian for Strongly Correlated Quantum Materials](https://arxiv.org/abs/2608.14208)
...
### [45] [SymQuPS: Symbolic Quantum Phase Space Algebra in Python](https://arxiv.org/abs/2608.14263)
...
### [46] [Qu-Trefoil: Large-Scale Quantum Circuit Simulator Working on FPGA With SATA Storages](https://arxiv.org/abs/2608.14285)
...
### [47] [Krylov complexity and Berry phase in quantum adiabatic dynamics](https://arxiv.org/abs/2608.14325)
...
### [48] [Equivalence Between Average-Case Hardness of Learning and Cryptography for Mixed Quantum States](https://arxiv.org/abs/2608.14331)
...
### [49] [Analytical Theory of Higher-Order Collective Spin Interactions in Cavity Quantum Electrodynamics](https://arxiv.org/abs/2608.14343)
...
### [50] [Native multi-qubit gates on a single-junction unimon circuit](https://arxiv.org/abs/2608.14357)
...
### [51] [Linearised quantum signal processing](https://arxiv.org/abs/2608.14387)
...
### [52] [To $\mathcal{PT}$ or not to $\mathcal{PT}$: Noise-induced escape and nonlinear-damping stabilization in a parity-time dimer](https://arxiv.org/abs/2608.14468)
...
### [53] [Current fluctuations in a non-additive open quantum system: breakdown of the quantum-jump approach](https://arxiv.org/abs/2608.14469)
...
### [54] [Measurement-Feedback Quantum Information Engine: Coherence-Transition Interference and Correlated Work Statistics](https://arxiv.org/abs/2608.14493)
...
### [55] [On first-order thermodynamic equilibrium conditions for fluid-fluid and solid-phase interfaces](https://arxiv.org/abs/2608.13603)
...
### [56] [Far-from-equilibrium topological phase transition in one dimension](https://arxiv.org/abs/2608.13658)
...
### [57] [Far-from-equilibrium scaling of non-abelian Goldstone modes](https://arxiv.org/abs/2608.13666)
...
### [58] [Small-world structure of quantum computer hardware](https://arxiv.org/abs/2608.13855)
...
### [59] [Generalizing the multidimensional thermodynamic uncertainty relation to combinations of arbitrary counting variables](https://arxiv.org/abs/2608.14276)
...
### [60] [Linear response across interaction regimes in two-dimensional ferromagnets](https://arxiv.org/abs/2608.14477)
...
### [61] [Complete Suppression of Thermomagnetic Instabilities in Nb Superconducting Films by Combined Metallic Layers and Ion Irradiation](https://arxiv.org/abs/2608.13699)
...
### [62] [Superconductivity in strongly overdoped cuprates: beyond the single-band model](https://arxiv.org/abs/2608.14090)
...
### [63] [Simplified Silicon Nitride Nanomembrane Circuits for van der Waals Integration](https://arxiv.org/abs/2608.14158)
...
### [64] [Strong photoresponse of edge two-dimensional electrons in a magnetic field](https://arxiv.org/abs/2608.13811)
...
### [65] [Thermal effect on the anomaly-induced electromechanical response in gapped graphene](https://arxiv.org/abs/2608.13912)
...
### [66] [Disorder signatures emerging at millikelvin temperatures in Si/SiGe field-effect stacks](https://arxiv.org/abs/2608.14224)
...
### [67] [Floquet Superlattices and Edge States in Graphene Nanoribbons](https://arxiv.org/abs/2608.14383)
...
### [68] [Universal aspects of bulk density of states in non-Hermitian lattices](https://arxiv.org/abs/2608.14508)
...
### [69] [Skyrmion Fractional Chern Insulator: An Intrinsically Multiband Route to Fractionalization in Rhombohedral Graphene](https://arxiv.org/abs/2608.14535)
