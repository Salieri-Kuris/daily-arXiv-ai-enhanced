...
### [7] [Planckian Bounds via Spectral Moments of Optical Conductivity](https://arxiv.org/abs/2512.09979)
*Debanjan Chowdhury*
...
### [8] [Measuring the Hall Viscosity of the Laughlin State on Noisy Quantum Computers](https://arxiv.org/abs/2512.09982)
...
### [9] [The magnetic structure of polar $G$-type charge and orbital ordered Hg-quadruple manganite perovskites](https://arxiv.org/abs/2512.10070)
...
### [10] [Gutzwiller approximation for paramagnetic ionic Hubbard model: Analytic expression for band - Mott insulator transition](https://arxiv.org/abs/2512.10096)
*Marcin M. Wysokiński*
...
### [11] [Large Anomalous Hall Effect in Topologically Trivial Double-$Q$ Magnets](https://arxiv.org/abs/2512.10168)
...
### [12] [Evaluating covalency using RIXS spectral weights: Silver fluorides vs. cuprates](https://arxiv.org/abs/2512.10219)
...
### [13] [Investigating the origin of topological-Hall-like resistivity in Zn-doped Mn2Sb ferrimagnet](https://arxiv.org/abs/2512.10285)
...
### [14] [Electronic structure, orbital-dependent renormalizations, and magnetic correlations in double-layer La$_3$Ni$_2$O$_7$ under doping tuning](https://arxiv.org/abs/2512.10527)
*I. V. Leonov*
...
### [15] [Anomalous Hall effect and rich magnetic phase diagram of Mn$_{100-x}$Rh$_{x}$ epitaxial films](https://arxiv.org/abs/2512.10291)
*Cong Wang,Zheng Li,Jing Meng,Hui Zhang,Haoyu Lin,Jiyuan Li,Kun Zheng,Yang Xu,Tian Shang,Qingfeng Zhan*

Main category: cond-mat.str-el

TL;DR: 研究了Mn$_{100-x}$Rh$_x$薄膜的磁性相图和霍尔效应，揭示了其磁性、电子传输特性和能带拓扑之间的关联，显示了在自旋电子学中的应用价值。


<details>
  <summary>Details</summary>
Motivation: 研究Mn$_{100-x}$Rh$_x$薄膜中的磁性相图和电子传输特性，以探索其在自旋电子学中的应用潜力。

Method: 利用磁控溅射技术外延生长Mn$_{100-x}$Rh$_x$薄膜，通过磁化、纵向电阻率和横向霍尔电阻率进行系统研究。

Result: 优化生长条件后获得了立方CsCl型结构的纯相薄膜，并构建了磁性相图。通过调节Rh含量，观察到三种不同的磁相区：铁磁、铁磁-反铁磁共存和反铁磁。所有薄膜在磁有序态下均表现出异常霍尔效应。

Conclusion: 系统研究表明，Mn$_{100-x}$Rh$_x$薄膜的磁性与电子能带拓扑结构之间存在强相关性，显示出在反铁磁自旋电子学中的巨大潜力。
...
### [16] [Binding of holes and competing spin-charge order in simple and extended Hubbard model on cylindrical lattice: An exact diagonalization study](https://arxiv.org/abs/2512.10577)
*Md Fahad Equbal,M. A. H. Ahsan*

Main category: cond-mat.str-el

TL;DR: Study shows how nonlocal Coulomb interactions in the Hubbard model affect hole-binding and collective order, revealing distinct phases for attractive and repulsive V.


<details>
  <summary>Details</summary>
Motivation: To investigate the binding of holes and the emergence of competing spin-charge order in the Hubbard model under varying interaction strengths.

Method: Exact diagonalization on the 3x4 cylindrical lattice for both the simple and extended Hubbard model.

Result: For the simple Hubbard model (V=0), weakly bound hole pairing mediated by magnetic correlations is observed. Introducing V reveals a rich phase diagram: attractive V leads to multi-hole clustering and phase separation, while repulsive V stabilizes CDW order coexisting with bound hole pairs. At strong coupling (U=10), these competitions become more pronounced.

Conclusion: The study establishes a comprehensive picture of how nonlocal Coulomb interactions reshape hole-binding and collective order in correlated electron systems, highlighting the distinct binding mechanisms of phase separation and correlation-mediated pairing.
...
### [17] [Magnetic anisotropy and dipolar interactions in the frustrated triangular-lattice magnet NaGdS_2](https://arxiv.org/abs/2512.10714)
...
TL;DR: NaGdS_2's magnetic order is suppressed by competing Heisenberg and dipolar interactions, with short-range ferromagnetic correlations observed below 180 mK.


<details>
  <summary>Details</summary>
Motivation: To investigate the magnetic properties of the rare-earth delafossite NaGdS_2, focusing on the role of Heisenberg and dipolar interactions in suppressing long-range order.

Method: The study combines bulk measurements (magnetization, specific heat, ac susceptibility, thermal expansion, magnetostriction) with local techniques (^23Na NMR, ESR) and simulations (McPhase) on polycrystalline and single-crystalline NaGdS_2 samples.

Result: NaGdS_2 shows weak antiferromagnetic exchange and absence of long-range order, but short-range order below 180 mK. ESR and ^23Na NMR indicate ferromagnetic correlations.

Conclusion: NaGdS_2 exhibits a unique interplay of Heisenberg-type and dipolar exchange interactions, suppressing long-range magnetic order while showing short-range ferromagnetic correlations.
...
### [19] [Hybrid quantum-classical matrix-product state and Lanczos methods for electron-phonon systems with strong electronic correlations: Application to disordered systems coupled to Einstein phonons](https://arxiv.org/abs/2512.10899)
*Heiko Georg Menzler,Suman Mondal,Fabian Heidrich-Meisner*

Main category: cond-mat.str-el

TL;DR: Hybrid quantum-classical methods simulate electron-phonon systems, revealing delocalization in disordered systems when coupled to classical oscillators.


<details>
  <summary>Details</summary>
Motivation: To simulate the time-dependence of electron-phonon systems with exact treatment of electronic correlations and classical treatment of optical-phonon degrees of freedom.

Method: Two quantum-classical hybrid methods: time-dependent Lanczos and matrix-product state, combined with the multi-trajectory Ehrenfest approach.

Result: Reliable results for small phonon frequencies (adiabatic regime); evidence of delocalization in disordered systems coupled to classical oscillators.

Conclusion: The study demonstrates that coupling strongly disordered systems to classical oscillators can lead to delocalization, destabilizing many-body localization in such systems.
...
### [20] [Electronic crystals and quasicrystals in semiconductor quantum wells: an AI-powered discovery](https://arxiv.org/abs/2512.10909)
*Filippo Gaggioli,Pierre-Antoine Graham,Liang Fu*

Main category: cond-mat.str-el

TL;DR: AI-powered neural network method reveals new quantum phase (electronic quasicrystal) in bilayer charge distributions of quantum wells.


<details>
  <summary>Details</summary>
Motivation: Theoretical understanding of strongly-correlated electrons in realistic semiconductor systems is limited, and the homogeneous electron gas is foundational for density functional theory and electronic phases in semiconductors.

Method: A neural network based variational approach starting from first principles to study quantum wells in three-dimensional geometry for various electron densities and well thicknesses.

Result: The method uncovered metallic and crystalline phases with both monolayer and bilayer charge distributions, including the discovery of a new quantum phase: the electronic quasicrystal.

Conclusion: The study reveals a new quantum phase of matter, the electronic quasicrystal, in bilayer charge distributions, demonstrating the potential of AI-powered methods for studying strongly-correlated electrons.
...
### [21] [Deep Thermalization and Measurements of Quantum Resources](https://arxiv.org/abs/2512.09999)
...
### [22] [A Unified Linear Algebraic Framework for Physical Models and Generalized Contextuality](https://arxiv.org/abs/2512.10000)
*Farid Shahandeh,Theodoros Yianni,Mina Doosti*

Main category: quant-ph

TL;DR: A unified framework for studying contextuality via matrix factorization, introducing equirank conditions and new proofs for ontological contextuality in operational theories.


<details>
  <summary>Details</summary>
Motivation: To provide a systematic and unified approach for studying contextuality in operational theories by leveraging linear-algebraic techniques and matrix factorization, enabling simpler and model-agnostic criteria for noncontextuality.

Method: The authors develop a bottom-up, statistics-first framework using the COPE matrix to encode probabilistic content. They unify five model classes through constrained factorizations and introduce equirank factorizations as core structural elements of GPTs and noncontextual ontological models.

Result: The paper identifies equirank nonnegative matrix factorization (ENMF) as a criterion for noncontextuality, applies it to establish contextuality in specific theories (e.g., boxworld), and derives lower bounds on ontological dimensionality for sparsity patterns.

Conclusion: The paper reframes contextuality as a matrix factorization problem, introducing a unified structural framework for studying nonclassical resources and establishing new criteria and methods to analyze contextuality in operational theories.
...
### [23] [Broadband Spatio-Spectral Mode Conversion via Four-Wave Mixing](https://arxiv.org/abs/2512.10045)
...
### [24] [Quantumness via Discrete Structures](https://arxiv.org/abs/2512.10063)
*Ravi Kunjwal*
...
### [25] [Gradient projection method and stochastic search for some optimal control models with spin chains. I](https://arxiv.org/abs/2512.10093)
*Oleg V. Morzhin*
...
### [26] [Programmable Quantum Photonic Interfaces for Quantum Networking](https://arxiv.org/abs/2512.10140)
...
### [27] [Engineer coherent oscillatory modes in Markovian open quantum systems](https://arxiv.org/abs/2512.10144)
...
### [28] [Upper Bounds on Fluctuation Growths of Observables in Open Quantum Systems](https://arxiv.org/abs/2512.10153)
*Newshaw Bahreyni,Paul M. Alsing,Carlo Cafaro,Walid Redjem,Christian Corda*

Main category: quant-ph

TL;DR: Study extends fluctuation growth bounds to open quantum systems, finding looser bounds when more details are included.


<details>
  <summary>Details</summary>
Motivation: To extend the understanding of fluctuation growth bounds from closed to open quantum systems, exploring how different levels of system details affect these bounds.

Method: For open quantum systems, the study employed Taylor expansion and the standard time-ordered evolution via the Dyson series in one case, and in another case, no specific information about the evolution was considered. The rate of fluctuation growth was analyzed in both scenarios.

Result: The upper bounds for the rate of fluctuation growth in open quantum systems were found to be looser when more details (e.g., separating system and state dynamics) were included, compared to the bounds in closed systems.

Conclusion: Including more details by separating the contributions of the system and state dynamics in open quantum systems leads to looser bounds for the rate of fluctuation growth, as compared to closed systems.
...
### [29] [Eight-Qubit Operation of a 300 mm SiMOS Foundry-Fabricated Device](https://arxiv.org/abs/2512.10174)
...
### [30] [Simultaneous Classical and Quantum Communications: Recent Progress and Three Challenges](https://arxiv.org/abs/2512.10176)
*Phuc V. Trinh,Shinya Sugiura,Carlo Ottaviani,Chao Xu,Lajos Hanzo*

Main category: quant-ph

TL;DR: Proposes protocols for simultaneous classical and quantum communications using shared transceivers and explores extending quantum communication to terahertz and microwave frequencies, addressing integration challenges.


<details>
  <summary>Details</summary>
Motivation: To address challenges such as high costs, compatibility issues, and hardware deployment difficulties in integrating quantum communications into classical networks, the paper aims to develop efficient and practical solutions.

Method: The study explores novel protocols for joint modulation and decoding of classical and quantum information on the same signal using a single set of transceivers. Additionally, it investigates extending quantum communication to non-traditional frequencies like terahertz, millimeter-wave, and microwave.

Result: The paper demonstrates the feasibility of simultaneous classical and quantum communications using shared transceivers and explores the potential of extending quantum communication to a broader range of frequencies.

Conclusion: The paper highlights challenges in integrating quantum communications into classical networks and proposes novel protocols for simultaneous classical and quantum communications using single transceivers. It also explores extending quantum communication capabilities beyond traditional optical bands, while identifying open problems for practical implementation.
...
### [31] [Quantum Internet in the Sky: Vision, Challenges, Solutions, and Future Directions](https://arxiv.org/abs/2512.10181)
...
### [32] [Optical fuse based on the photorefractive effect for defending the light-injection attacks of quantum key distribution](https://arxiv.org/abs/2512.10205)
...
### [33] [Entropic Uncertainty Relations with Quantum Memory in Accelerated Frames via Unruh-DeWitt Detectors](https://arxiv.org/abs/2512.10210)
...
### [34] [Chaos, Entanglement and Measurement: Field-Theoretic Perspectives on Quantum Information Dynamics](https://arxiv.org/abs/2512.10484)
...
### [35] [Optimal learning of quantum channels in diamond distance](https://arxiv.org/abs/2512.10214)
...
### [36] [Generating strong mechanical squeezing via combined squeezed vacuum field and two-tone driving](https://arxiv.org/abs/2512.10215)
*Xiao-Jie Wu,Huan-Huan Cheng,Cheng-Hua Bai,Shao-Xiong Wu*

Main category: quant-ph

TL;DR: 结合双调驱动和挤压真空场的新方案显著提升机械挤压性能，具有高操作灵活性和强鲁棒性。


<details>
  <summary>Details</summary>
Motivation: 改进机械挤压状态的生成性能，解决传统方法中严格的参数匹配要求问题。

Method: 提出了一种基于双调驱动和挤压真空场相结合的新方案，通过相位匹配实现机械振荡器的位置和动量挤压。

Result: 该方案在整个红/蓝失谐比范围内显著提高了机械挤压性能，并且挤压度随挤压参数r非线性增强。

Conclusion: 该方案通过结合双调驱动和挤压真空场的机制，显著提高了机械挤压性能，并且在实验实现上具有高度的操作灵活性，同时对腔耗散和环境热噪声表现出强鲁棒性。
...
### [37] [Integrated Generation and Purification of Entangled Coherent States for Non-Gaussian Teleportation](https://arxiv.org/abs/2512.10225)
...
### [41] [Gradient projection method and stochastic search for some optimal control models with spin chains. II](https://arxiv.org/abs/2512.10290)
*Oleg V. Morzhin*
...
### [42] [Efficient simulation of low-entanglement bosonic Gaussian states in polynomial time](https://arxiv.org/abs/2512.10643)
*Tong Liu,Hui-Ke Jin,Tao Xiang,Hong-Hao Tu*

Main category: quant-ph

TL;DR: An efficient algorithm converts bosonic Gaussian states into MPSs with cost driven by entanglement, not mode count, showing speedups in low-entanglement cases.


<details>
  <summary>Details</summary>
Motivation: Bosonic Gaussian states are difficult to simulate classically due to the hafnian bottleneck. The goal is to develop an efficient algorithm to convert these states into MPSs with computational cost governed by entanglement rather than the number of bosonic modes.

Method: Combines a Gaussian singular value decomposition with a projected-creation-operator mapping to construct local MPS tensors without computing hafnians.

Result: The algorithm demonstrates substantial speedups over previous tensor-network approaches in the low-entanglement regime, as shown in benchmarking on covariance matrices from Jiuzhang 2.0 and Jiuzhang 4.0 experiments.

Conclusion: The method provides a scalable classical simulation framework for bosonic Gaussian states with limited entanglement and extends the applicability of MPS-based methods to a broad range of bosonic systems.
...
### [43] [Tunable discrete quasi-time crystal from a single drive](https://arxiv.org/abs/2512.10303)
...
### [44] [Partitioned Expansions for Approximate Tensor Network Contractions](https://arxiv.org/abs/2512.10910)
...
### [45] [Improved gap dependence in adiabatic state preparation by adaptive schedule](https://arxiv.org/abs/2512.10329)
*Dong An,Xi Guo*

Main category: quant-ph

TL;DR: A nonlinear adaptive strategy improves adiabatic quantum computing efficiency by reducing the gap dependence from quadratic to linear, proving optimality for certain systems.


<details>
  <summary>Details</summary>
Motivation: The evolution time in adiabatic quantum computing often scales quadratically with the inverse Hamiltonian spectral gap, leading to inefficient computational complexity. This motivates the development of a more efficient scheduling strategy.

Method: We propose a nonlinear adaptive strategy for determining the time scheduling function and use variational analysis to evaluate its performance. We compare our method with the traditional linear schedule to demonstrate its advantages.

Result: Our nonlinear adaptive strategy achieves a quadratically improved gap dependence, reducing it from inverse quadratic to inverse linear for a wide range of systems. We prove its optimality for systems with linear gaps and partial optimality for general systems, while showing the linear schedule is never optimal.

Conclusion: Our work introduces a nonlinear adaptive strategy for optimizing the time scheduling function in adiabatic quantum computing, significantly improving the computational complexity from quadratic to inverse linear dependence on the Hamiltonian spectral gap. We demonstrate the optimality of this schedule for systems with linear gaps and its partial optimality for general systems, while proving that the commonly used linear schedule is suboptimal.
...
### [46] [Optomagnonic generation of entangled travelling fields with different polarizations](https://arxiv.org/abs/2512.10338)
...
### [47] [Generation of mechanical cat-like states via optomagnomechanics](https://arxiv.org/abs/2512.10347)
...
### [48] [On the Optimality of a Quantum Key Distribution](https://arxiv.org/abs/2512.10351)
*Georgi Bebrov*

Main category: quant-ph

TL;DR: The paper defines 'optimality' for QKD systems and shows how to achieve it, introducing efficient versions of BB84 and twin-field QKD.


<details>
  <summary>Details</summary>
Motivation: The motivation is to enhance the performance of QKD systems by minimizing resource usage (qubits and bits) while maximizing the number of secure key bits generated.

Method: The method involves defining a metric called 'optimality' to measure the maximum total efficiency of a QKD system under any parameter values, focusing on asymptotic operation where infinitely many quantum systems are used.

Result: The paper presents optimal versions of BB84-QKD and twin-field QKD, achieving high efficiency through a combination of a capacity-reaching quantum channel and a fully compressed classical channel.

Conclusion: The paper introduces a method to determine if a QKD system operates optimally by defining a quantity called 'optimality', and demonstrates how to achieve it through the implementation of an efficient QKD system, including optimal versions of BB84-QKD and twin-field QKD.
...
### [49] [Understanding Surface-Induced Decoherence of NV Centers in Diamond](https://arxiv.org/abs/2512.10726)
*Jonah Nagura,Mykyta Onizhuk,Giulia Galli*

Main category: quant-ph

TL;DR: The study quantifies how surface properties affect NV center coherence, identifying a crossover depth and highlighting the role of spin-phonon relaxation and surface-spin hopping for optimizing quantum sensors.


<details>
  <summary>Details</summary>
Motivation: To understand and mitigate the negative impact of magnetic and electric surface noise on the coherence properties of nitrogen vacancy (NV) centers near diamond surfaces.

Method: Atomistic models of diamond surfaces derived with density functional theory and decoherence time calculations using cluster correlation expansion methods.

Result: A crossover depth where coherence time (T₂) transitions from surface-limited to bulk-limited values was identified. Surface crystallographic orientation, functionalization, and unpaired electron density significantly affect T₂. Spin-phonon relaxation modulates T₂, and surface-spin hopping models are essential for accurately describing surface noise.

Conclusion: The study provides guidelines for optimizing diamond surface engineering to enhance NV center coherence, crucial for quantum sensing and information processing applications.
...
### [50] [Loophole-free Bell-inequality violation between atomic states in cavity-QED systems mediated by hybrid atom-light entanglement](https://arxiv.org/abs/2512.10378)
*Pei-Zhe Li,Soumyakanti Bose,Hyunseok Jeong,William J. Munro,Kae Nemoto,Nicolò Lo Piparo*

Main category: quant-ph

TL;DR: A scalable method for testing Bell nonlocality and DI-QKD using hybrid atom-light entanglement, showing promising results for future quantum networks.


<details>
  <summary>Details</summary>
Motivation: To test Bell nonlocality and implement device-independent quantum key distribution (DI-QKD) between distant atomic states in cavity-based architectures.

Method: Developed a full theoretical model incorporating realistic noise sources like transmission loss, limited light-matter coupling efficiency, and imperfect detection.

Result: Strong Bell-CHSH violations and secure key generation over tens of kilometers are achievable with current or near-term technology.

Conclusion: The study establishes cavity-based platforms with coherent-state encodings as a promising foundation for scalable, device-independent quantum communication networks.
...
### [51] [Quantum Separability Criteria Based on Symmetric Measurements](https://arxiv.org/abs/2512.10380)
*Yu Lu,Wen Zhou,Meng Su,Hong-Xing Wu,Shao-Ming Fei,Zhi-Xi Wang*

Main category: quant-ph

TL;DR: New separability criteria using local symmetric measurements outperform existing methods in detecting entanglement, with potential for broader application.


<details>
  <summary>Details</summary>
Motivation: To provide more effective entanglement detection methods compared to existing approaches.

Method: Utilizes local symmetric measurements to develop separability criteria for bipartite systems.

Result: The criteria demonstrate improved effectiveness in detecting entanglement and potential for generalization to multipartite systems.

Conclusion: The proposed separability criteria based on local symmetric measurements show promise in detecting entanglement more effectively and can potentially be extended to multipartite systems.
...
### [52] [Ising on the donut: Regimes of topological quantum error correction from statistical mechanics](https://arxiv.org/abs/2512.10399)
*Lucas H. English,Sam Roberts,Stephen D. Bartlett,Andrew C. Doherty,Dominic J. Williamson*

Main category: quant-ph

TL;DR: An exact mapping between toric codes and the Ising model enables analytic solutions for quantum error correction performance, advancing the design and understanding of topological codes.


<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of predicting the performance of quantum error correction (QEC) codes, which typically requires large-scale numerical simulations due to the lack of analytic solutions.

Method: Exploiting an exact mapping from a toric code under bit-flip noise (post-selected on being syndrome free) to the exactly-solvable two-dimensional Ising model on a torus to derive an analytic solution for the logical failure rate.

Result: Derived closed-form expressions for the logical failure rate in four regimes: path-counting, below-threshold (ordered), near-threshold (critical), and above-threshold (disordered). Also introduced an effective surface tension model and a new scaling ansatz for non-post-selected codes.

Conclusion: The study provides a new toolkit for designing, benchmarking, and understanding topological codes beyond current computational limits by bridging statistical mechanics theory and quantum error correction practice.
...
### [53] [Robust population transfer by a detuning sign jump: from two-state quantum system to SU(2)-symmetric three-state quantum system](https://arxiv.org/abs/2512.10432)
...
### [54] [Shot and Architecture Adaptive Subspace Variational Quantum Eigensolver for Microwave Simulation](https://arxiv.org/abs/2512.10458)
...
### [55] [Optimal Distributed Similarity Estimation for Unitary Channels](https://arxiv.org/abs/2512.10465)
*Congcong Zheng,Kun Wang,Xutao Yu,Ping Xu,Zaichen Zhang*

Main category: quant-ph

TL;DR: The paper addresses distributed similarity estimation for unitary channels, showing query complexity Θ(√d) and demonstrating the advantage of shared randomness.


<details>
  <summary>Details</summary>
Motivation: To address the task of estimating the similarity between unitary channels implemented on different quantum devices (DSEU), and to explore the role of shared randomness in distributed quantum learning.

Method: Two estimation algorithms for DSEU are proposed, utilizing the randomized measurement toolbox. The query complexities of these algorithms are both O(√d). Lower bounds are established to prove that Θ(√d) queries are necessary and sufficient.

Result: The query complexity of DSEU is Θ(√d) for both incoherent and coherent accesses, with a square-root advantage over independent classical shadow.

Conclusion: The study provides practical and theoretically optimal tools for quantum devices benchmarking and distributed quantum learning, demonstrating the power of shared randomness in quantum learning.
...
### [56] [On Simplest Kochen-Specker Sets](https://arxiv.org/abs/2512.10483)
*Mladen Pavicic*

Main category: quant-ph

TL;DR: 本文反驳了之前关于‘最简单的3D上下文集合’的声明，证明了更简单的集合存在，并展示了自动生成方法的强大功能。还讨论了上下文集合的分类和定义问题。


<details>
  <summary>Details</summary>
Motivation: 针对之前声称发现最简单的3D上下文集合的论文，本文旨在澄清其非基础性，并进一步分析和比较不同维度的上下文集合。

Method: 通过分析已知的上下文集合的生成方法，特别是通过自动生成向量组件来验证和比较不同的3D上下文集合。作者还证明了自动生成方法的高效性。

Result: 证明了存在比之前宣称的集合更简单的3D上下文集合，并展示了自动生成方法的有效性，能够在瞬间生成所有已知的最小上下文集合。

Conclusion: 本文得出结论，之前的3D上下文集合不能被视为基础性集合，因为存在许多具有更少完全基的集合。此外，自动生成方法能在极短时间内产生所有已知最小上下文集合。文章还讨论了不同类型的上下文集合及其定义中的模糊性。
...
### [57] [The relativistic reason for quantum probability amplitudes](https://arxiv.org/abs/2512.10497)
...
### [58] [Tianyan: Cloud services with quantum advantage](https://arxiv.org/abs/2512.10504)
*Tianyan Quantum Group*

Main category: quant-ph

TL;DR: Tianyan Quantum Cloud Platform uses a 105-qubit superconducting processor to show quantum advantage, completing a task in minutes vs. millennia for classical computers. Accessible via Cqlib.


<details>
  <summary>Details</summary>
Motivation: To democratize access to high-performance quantum hardware and demonstrate practical quantum advantage, enabling the community to validate and explore quantum computing capabilities.

Method: The platform utilizes a 105-qubit superconducting quantum processor (Tianyan-287) with high operational fidelities (99.90% for single-qubit gates, 99.56% for two-qubit gates, and 98.7% for readout). It benchmarks performance via random circuit sampling on a 74-qubit system over 24 cycles.

Result: The platform completes one million samples of a benchmark task in 18.4 minutes, a task that would take state-of-the-art classical supercomputers approximately 16,000 years. Operational fidelities are high.

Conclusion: The Tianyan Quantum Cloud Platform demonstrates significant quantum advantage with its 105-qubit superconducting processor, completing a task in minutes that would take classical supercomputers millennia. The platform, accessible via Cqlib, aims to democratize high-performance quantum hardware access for community validation and exploration.
...
### [59] [Encoding parameters by measurement: Forgetting can be better in quantum metrology](https://arxiv.org/abs/2512.10541)
...
### [60] [Hybrid Quantum Annealing Approach for High-Dimensional and Multi-Criteria Constrained Quadratic Optimization in Arctic Ship Routing](https://arxiv.org/abs/2512.10544)
*Tara Kit,Kimsay Pov,Myeongseong Go,Leanghok Hour,Arim Ryou,Kiwoong Kim,Tae-Kyung Kim,Youngsun Han*

Main category: quant-ph

TL;DR: Hybrid quantum-classical solver for Arctic route optimization outperforms classical methods in speed, stability, and route quality.


<details>
  <summary>Details</summary>
Motivation: Address the operational and computational challenges posed by dynamic sea ice conditions in Arctic sea routes to enhance global trade efficiency.

Method: The study formulates a multi-criteria Arctic route optimization problem using CMEMS variables in a Constrained Quadratic Model (CQM) and solves it with D-Wave's hybrid quantum-classical solver, comparing results with classical MIQP solvers (Gurobi, CPLEX).

Result: The CQM approach shows 10 to 100 times faster convergence, stable runtimes, improved route smoothness (10%), and reduced total route length (1%) compared to classical solvers.

Conclusion: The hybrid quantum annealing approach via CQM formulation demonstrates significant improvements in speed, route smoothness, and computational efficiency for Arctic route optimization, outperforming classical MIQP solvers.
...
### [61] [Sensitivity threshold defines the optimal spin subset for ensemble quantum sensing](https://arxiv.org/abs/2512.10549)
...
### [62] [Quantum-Amplified M/G/1/K Simulation: A Comparator-Controlled Framework for Arbitrary Service Distributions](https://arxiv.org/abs/2512.10558)
*Or Peretz,Michal Koren,Nir Perel*

Main category: quant-ph

TL;DR: A quantum circuit for simulating M/G/1/K queues demonstrates high fidelity and reduced errors, marking the first end-to-end quantum framework for non-Markovian queueing systems.


<details>
  <summary>Details</summary>
Motivation: Classical simulation of finite-capacity single-server queues becomes computationally prohibitive with high service variability or precision requirements, motivating the development of a quantum simulation approach.

Method: The study introduces a quantum circuit for simulating an M/G/1/K queue, encoding service distributions via logarithmic-depth R_y rotations and enforcing buffer constraints with comparator-controlled phase gates. It leverages Grover iterations for variance reduction and closed-form confidence bounds.

Result: Empirical evaluations showed high fidelity (above 0.99 with four qubits, above 0.76 with ten qubits) and low Jensen-Shannon divergence (below 0.11). Waiting-time estimation errors reduced significantly under high traffic, remaining within 3% using registers up to 63 qubits.

Conclusion: This work establishes the first end-to-end quantum simulation framework for finite-buffer, non-Markovian queueing systems, demonstrating practical feasibility and providing a foundation for quantum-accelerated performance analysis.
...
### [63] [Insensitivity points and performance of open quantum interferometers under number- conserving & non-conserving Lindblad dynamics](https://arxiv.org/abs/2512.10559)
...
### [64] [Topology-Guided Quantum GANs for Constrained Graph Generation](https://arxiv.org/abs/2512.10582)
...
### [65] [All-photonic entanglement swapping with remote quantum dots](https://arxiv.org/abs/2512.10651)
...
### [66] [Pulsed learning for quantum data re-uploading models](https://arxiv.org/abs/2512.10670)
*Ignacio B. Acedo,Pablo Rodriguez-Grasa,Pablo Garcia-Azorin,Javier Gonzalez-Conde*

Main category: quant-ph

TL;DR: Pulse-based QML models outperform gate-based ones in accuracy and noise resilience, offering a promising alternative for NISQ-era applications.


<details>
  <summary>Details</summary>
Motivation: Overcome the trainability and noise-related issues of variational quantum circuits (VQCs) by exploring the underutilized potential of pulse-control level implementations.

Method: A pulse-based variant of data re-uploading is formulated, embedding trainable parameters directly into the native system's dynamics. Benchmarked on a simulated superconducting transmon processor with realistic noise profiles.

Result: The pulse-based model outperforms gate-based counterparts with higher test accuracy and improved generalization under equivalent noise conditions, showing higher fidelity under increased noise.

Conclusion: Pulse-native architectures may offer a viable and hardware-aligned path forward for practical QML in the NISQ era, demonstrating enhanced resilience to noise and control errors.
...
### [67] [A Cryogenic Muon Tagging System Based on Kinetic Inductance Detectors for Superconducting Quantum Processors](https://arxiv.org/abs/2512.10679)
...
### [68] [Advantage in distributed quantum computing with slow interconnects](https://arxiv.org/abs/2512.10693)
*Evan E Dobbs,Nicolas Delfosse,Aharon Brodutch*

Main category: quant-ph

TL;DR: Distributed quantum computing with slow interconnects and distributed CliNR outperforms monolithic QPUs, offering lower error rates and faster execution for near-term devices.


<details>
  <summary>Details</summary>
Motivation: The main bottleneck in distributed quantum computing is the slow rate of entanglement production between quantum processing units (QPUs). This work aims to prove that distributed architectures can outperform monolithic QPUs despite slow interconnects.

Method: Proposed a distributed version of the CliNR partial error correction scheme under specific constraints (slow interconnects, limited Bell pair generation), and validated its performance through circuit-level simulations and asymptotic analysis.

Result: Distributed CliNR achieves better performance (lower logical error rate and shorter depth) than monolithic implementations, even with entanglement generation times five times longer than gate times. Asymptotically, parallel Bell pair generation avoids stalling.

Conclusion: Distributed quantum computing with slow interconnects can outperform monolithic architectures, as demonstrated by the distributed CliNR scheme, which achieves lower logical error rates and shorter depths, making it suitable for near-term multi-QPU devices.
...
### [69] [Sub-Bath Cooling in Bosonic Systems: Gaussian Constraints and Non-Gaussian Enhancements](https://arxiv.org/abs/2512.10703)
...
### [70] [Scalable Optical Links for Controlling Bosonic Quantum Processors](https://arxiv.org/abs/2512.10706)
...
### [71] [Further Statistical Study of NISQ Experiments](https://arxiv.org/abs/2512.10722)
...
### [72] [Complexity and multi-functional variants of the Quantum-to-Quantum Bernoulli Factories](https://arxiv.org/abs/2512.10810)
...
### [73] [Quantum Approaches to Urban Logistics: From Core QAOA to Clustered Scalability](https://arxiv.org/abs/2512.10813)
...
### [74] [Estimating Detector Error Models on Google's Willow](https://arxiv.org/abs/2512.10814)
...
### [75] [Optimized Measurement Schedules for the Surface Code with Dropout](https://arxiv.org/abs/2512.10871)
...
### [76] [Multiple-time Quantum Imaginary Time Evolution](https://arxiv.org/abs/2512.10875)
...
### [77] [ENTCALC: Toolkit for calculating geometric entanglement in multipartite quantum systems](https://arxiv.org/abs/2512.10884)
...
### [78] [Quantifying classical and quantum bounds for resolving closely spaced, non-interacting, simultaneously emitting dipole sources in optical microscopy](https://arxiv.org/abs/2512.10889)
...
### [79] [Qubit decoherence in dissipative two-photon resonator: real-time instantons and Wigner function](https://arxiv.org/abs/2512.10921)
...
### [80] [Noisy Quantum Learning Theory](https://arxiv.org/abs/2512.10929)
...
### [81] [Quantum Monte Carlo in Classical Phase Space with the Wigner-Kirkwood Commutation Function. Results for the Saturation Liquid Density of $^4$He](https://arxiv.org/abs/2512.09948)
*Phil Attard*
...
### [82] [Statistical Field Theory of Interacting Nambu Dynamics](https://arxiv.org/abs/2512.09965)
*Tamiaki Yoneya*
...
### [83] [Universal relaxation speedup in open quantum systems through transient conditional and unconditional resetting](https://arxiv.org/abs/2512.10005)
...
### [84] [Bose one-component plasma in 2D: a Monte Carlo study](https://arxiv.org/abs/2512.10216)
*Massimo Boninsegni*
...
### [85] [Discreteness-induced spatial chaos versus fluctuation-induced spatial order in stochastic Turing pattern formation](https://arxiv.org/abs/2512.10500)
...
### [86] [Janus Percolation in Anisotropic Limited-Degree Networks](https://arxiv.org/abs/2512.10566)
...
### [87] [Multiloop calculations with parametric integration in critical dynamics: the four-loop analytic study of model A of $φ^4$ theory](https://arxiv.org/abs/2512.10591)
*Loran Ts. Adzhemyan,Diana A. Davletbaeva,Daniil A. Evdokimov,Mikhail V. Kompaniets*

Main category: cond-mat.stat-mech

TL;DR: First analytical four-loop calculation of exponent z in model A of critical dynamics using parametrical integration with hyperlogarithms, discussing unique challenges like early linear-irreducible diagrams.


<details>
  <summary>Details</summary>
Motivation: The motivation is to extend analytical calculations in critical dynamics to higher orders of perturbation theory, specifically four loops, which has not been achieved before. The paper also aims to explore the application of modern mathematical methods like parametrical integration with hyperlogarithms in this context.

Method: The study employs the modern method of parametrical integration with hyperlogarithms to analytically calculate the four-loop exponent z. It addresses challenges specific to critical dynamics, such as the presence of linear-irreducible diagrams at four loops, which differ from static models.

Result: The paper presents the first analytical four-loop calculation of exponent z in model A of critical dynamics. It identifies and discusses the peculiarities of applying the method, such as the early appearance of linear-irreducible diagrams at four loops.

Conclusion: The paper successfully performs an analytical four-loop calculation of exponent z in model A of critical dynamics, highlighting the successful application of the modern method of parametrical integration with hyperlogarithms. It also notes the uniqueness of achieving such a high order of perturbation theory for critical dynamics models.
...
### [88] [On fast charged particles scattering on zigzag nanotube](https://arxiv.org/abs/2512.09943)
...
### [89] [Characterizing second-order topological insulators via entanglement topological invariant in two-dimensional systems](https://arxiv.org/abs/2512.09962)
...
### [90] [Fluctuation-induced giant magnetoresistance in charge-neutral graphene](https://arxiv.org/abs/2512.09988)
...
### [91] [Direct Epitaxial Growth and Deterministic Device Integration of high-quality Telecom O-Band InGaAs Quantum Dots on Silicon Substrate](https://arxiv.org/abs/2512.10073)
...
### [92] [Harnessing Vacuum Fluctuations to Shape Electronic and Photonic Behavior](https://arxiv.org/abs/2512.10145)
*Qing-Dong Jiang*

Main category: cond-mat.mes-hall

TL;DR: Vacuumronics integrates vacuum quantum fluctuations with low-dimensional materials for advanced control over quantum light-matter interactions, benefiting quantum photonics and optoelectronics.


<details>
  <summary>Details</summary>
Motivation: The motivation is to harness vacuum quantum fluctuations to enable unprecedented control over material properties and photonic responses, advancing quantum technologies.

Method: The method involves integrating cavity-enhanced or surface-modified vacuum quantum fluctuations with low-dimensional materials.

Result: The result is the emergence of vacuumronics as a new paradigm, opening novel pathways for engineering quantum light-matter interactions.

Conclusion: The paper concludes that vacuumronics offers a transformative approach to control material properties and photonic responses at micro- and nanoscales, with significant potential for quantum photonics, optoelectronics, and material design.
...
### [93] [Deterministic Electrical Control of Single Magnetic Bubbles in Nanostructured Cells](https://arxiv.org/abs/2512.10242)
...
TL;DR: The study shows how to electrically control and detect single magnetic bubbles in Fe3Sn2, advancing spintronic device potential.


<details>
  <summary>Details</summary>
Motivation: To address the uncertainty in electrical manipulation methods for magnetic bubbles, a promising candidate for spintronic data bits.

Method: Nanosecond pulsed currents were used to induce and delete single magnetic bubbles, analyzed through thermal heating, spin-transfer torque effects, and micromagnetic simulations. Detection was achieved via anisotropic magnetoresistance using a four-probe method.

Result: Deterministic creation and deletion of single magnetic bubbles using pulsed currents, with in-situ detection capabilities.

Conclusion: The research demonstrates successful electrical manipulation and detection of single magnetic bubbles in Fe3Sn2 nanostructures, which could advance bubble-based spintronic devices.
...
### [94] [Stable skyrmion bundles at room temperature and zero magnetic field in a chiral magnet](https://arxiv.org/abs/2512.10243)
*Yongsen Zhang,Jin Tang,Yaodong Wu,Meng Shi,Xitong Xu,Shouguo Wang,Mingliang Tian,Haifeng Du*

Main category: cond-mat.mes-hall

TL;DR: 在室温且零磁场条件下，通过脉冲电流和反向磁场实现了稳定高Q值斯格明子束，揭示了其电磁特性与拓扑电荷的关系。


<details>
  <summary>Details</summary>
Motivation: 探索基于拓扑电荷Q的拓扑自旋电子学，解决在室温且零磁场条件下实现稳定斯格明子束的难题，为实际器件应用奠定基础。

Method: 结合脉冲电流和反向磁场的方法，在Co8Zn10Mn2手性磁体中实现了不同整数Q值的斯格明子束，并通过微磁模拟验证实验现象。

Result: 实验成功实现了Q值高达24的斯格明子束，绘制了温度与磁场的关系相图，并通过微磁模拟验证了斯格明子束的结构与行为。

Conclusion: 通过结合脉冲电流和反向磁场，实验实现了在室温且零磁场条件下稳定的高Q值斯格明子束，并验证了其电磁特性与拓扑电荷的关系。通过场驱动湮灭实验和相图绘制，以及微磁模拟的验证，揭示了斯格明子束的本质是分数霍普离子环绕的斯格明子管。
...
### [95] [Cascade of topological phase transitions and revival of topological zero modes in imperfect double helical liquids](https://arxiv.org/abs/2512.10335)
...
### [96] [Surface acoustic wave-driven valley current generation in intervalley coherent states](https://arxiv.org/abs/2512.10395)
*Hiroto Tanaka,Youichi Yanase*

Main category: cond-mat.mes-hall

TL;DR: The study shows that intervalley coherent states generate anomalous valley currents via surface acoustic waves, with enhanced effects in rhombohedral graphene, offering insights into valley-gauge-symmetry breaking.


<details>
  <summary>Details</summary>
Motivation: To explore anomalous responses, particularly those analogous to superconductivity, resulting from valley-gauge-symmetry breaking.

Method: The researchers demonstrated the anomalous valley-current generation driven by surface acoustic waves (SAWs) and performed numerical analysis to show the enhancement of valley-current generation in rhombohedral graphene.

Result: The IVC order produces anomalous valley currents with a power-law dependence for low-frequency SAWs and significantly enhances valley-current generation in rhombohedral graphene.

Conclusion: The study highlights the potential of IVC order in generating anomalous valley currents and opens new avenues for investigating phenomena related to valley-gauge-symmetry breaking.
...
### [98] [Excitation energies and UV-Vis absorption spectra from INDO/s+ML](https://arxiv.org/abs/2512.10397)
...
### [99] [Shaping chaos in bilayer graphene cavities](https://arxiv.org/abs/2512.10914)
...
### [100] [The Feynman paradox in a spherical axion insulator](https://arxiv.org/abs/2512.10436)
...
### [101] [Nanoscale magnetometry of a synthetic three-dimensional spin texture](https://arxiv.org/abs/2512.10476)
...
TL;DR: NV-SPM enables quantitative nanoscale imaging of 3D spin textures in SAFs, revealing domain structures and magnetic noise.


<details>
  <summary>Details</summary>
Motivation: To achieve non-invasive, quantitative nanoscale magnetic imaging of multilayered SAFs, enabling the understanding and tailoring of 3D spin textures for new functionalities.

Method: Nitrogen-vacancy scanning probe microscopy (NV-SPM) under ambient conditions was used to perform quantitative vector-field magnetometry on a multilayered SAF structure.

Result: The study successfully characterized antiferromagnetic domains, detected ferromagnetic stripes, and measured magnetic noise from spin-waves, revealing distinct fingerprints from different imaging modes.

Conclusion: This study demonstrates the effectiveness of NV-SPM for quantitative vector-field magnetometry in multilayered SAFs, providing detailed insights into spin textures and domain behaviors.
...
### [102] [Thermally-controlled interlayer exchange and field-induced anisotropy in synthetic antiferromagnets](https://arxiv.org/abs/2512.10511)
*O. Kozlov,V. Kalita,S. Reshetniak,A. Kravets,D. Polishchuk,V. Korenivski*

Main category: cond-mat.mes-hall

TL;DR: Thermal control of interlayer exchange in synthetic antiferromagnets with paramagnetic spacers switches between antiferromagnetic and ferromagnetic alignments, driven by spacer polarization near its Curie point.


<details>
  <summary>Details</summary>
Motivation: The study aims to explore how thin paramagnetic spacers in synthetic antiferromagnets can thermally control interlayer exchange, leading to unique magnetic alignments dependent on temperature.

Method: The research utilized Fe(2 nm)/Cr(0.4 nm)/Fe₁₇.₅Cr₈₂.₅(0.9 nm)/Cr(0.4 nm)/Fe(2 nm) multilayers, with the inner spacer Fe₁₇.₅Cr₈₂.₅ being paramagnetic at and above room temperature. The magnetization reversal was analyzed to identify the field-induced uniaxial anisotropy.

Result: The system exhibits antiferromagnetic alignment at high temperatures and ferromagnetic alignment at low temperatures, driven by the magnetic polarization of the spacer near its Curie point. The magnetization reversal shows a field-induced uniaxial anisotropy.

Conclusion: The study demonstrates that the thermal control of interlayer exchange in synthetic antiferromagnets with thin paramagnetic spacers leads to a temperature-dependent switching between antiferromagnetic and ferromagnetic alignments. This behavior is attributed to the magnetic polarization of the spacer near its Curie point, despite the lack of intrinsic magnetocrystalline anisotropy in the Fe layers.
...
### [103] [Edge states of a Bi$_2$Se$_3$ nanosheet in a perpendicular magnetic field](https://arxiv.org/abs/2512.10627)
...
### [104] [Brightening of dark trions in monolayer WS$_2$ via localization of surface plasmons](https://arxiv.org/abs/2512.10856)
...
### [105] [Topological Engineering of a Frustrated Antiferromagnetic Triradical in Aza-Triangulene Architectures](https://arxiv.org/abs/2512.10869)
