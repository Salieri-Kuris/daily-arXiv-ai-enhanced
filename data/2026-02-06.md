...
### [4] [Higher-Order Topological Superconductivity and Electrically Tunable Majorana Corner Modes in Monolayer MnXPb$_2$ (X=Se, Te)-Pb Heterostructure](https://arxiv.org/abs/2602.05505)
...
### [5] [Raman response of collective modes in multicomponent superconductors](https://arxiv.org/abs/2602.05607)
...
### [6] [Electronic Structure and Superconducting Gap of HgBa$_2$Ca$_2$Cu$_3$O$_{8+δ}$ Revealed by Laser-Based Angle-Resolved Photoemission Spectroscopy](https://arxiv.org/abs/2602.05624)
...
### [7] [Fit-Free Optical Determination of Electronic Thermalization Time in Nematic Iron-Based Superconductors](https://arxiv.org/abs/2602.05771)
...
### [8] [Minimal Hamiltonian deformations as bulk probes of effective non-Hermiticity in Dirac materials](https://arxiv.org/abs/2602.05040)
...
### [9] [Strong radial electric field scaling near nanoscale conductive filaments and the ReRAM resistive switching mechanism](https://arxiv.org/abs/2602.05067)
...
### [10] [Transport signatures of topological commensurate off-diagonal Aubry-André-Harper chain](https://arxiv.org/abs/2602.05338)
*Arpita Koley*
...
### [11] [Compact self-matched gyrators using edge magnetoplasmons](https://arxiv.org/abs/2602.05439)
...
### [12] [Direct observation of propagating spin waves in a spin-Hall nano-oscillator](https://arxiv.org/abs/2602.05603)
...
### [13] [Color Centers and Hyperbolic Phonon Polaritons in Hexagonal Boron Nitride: A New Platform for Quantum Optics](https://arxiv.org/abs/2602.05736)
...
### [14] [Anomalous thermoelectric and thermal Hall effects in irradiated altermagnets](https://arxiv.org/abs/2602.05745)
...
### [15] [Scalable testing of quantum error correction](https://arxiv.org/abs/2602.04921)
...
### [16] [Agnostic Parameter Estimation with Large Spins](https://arxiv.org/abs/2602.04934)
...
### [17] [Instance-optimal high-precision shadow tomography with few-copy measurements: A metrological approach](https://arxiv.org/abs/2602.04952)
...
### [18] [Efficient time-evolution of matrix product states using average Hamiltonians](https://arxiv.org/abs/2602.04955)
...
### [19] [Topological frustration and quantum resources](https://arxiv.org/abs/2602.04960)
...
### [20] [Tighter Asymptotic Key Rates for Intensity-Correlated Decoy-State QKD via Nonlinear Programming](https://arxiv.org/abs/2602.04966)
...
### [21] [Taming multiparty entanglement at measurement-induced phase transitions](https://arxiv.org/abs/2602.04969)
...
### [22] [Distributed Quantum Error Mitigation: Global and Local ZNE encodings](https://arxiv.org/abs/2602.04981)
...
### [23] [QuantumGS: Quantum Encoding Framework for Gaussian Splatting](https://arxiv.org/abs/2602.05047)
...
### [24] [Quantum statistical functions](https://arxiv.org/abs/2602.05821)
*Haruki Emori*
...
### [25] [Quantum Key Distribution with Imperfections: Recent Advances in Security Proofs](https://arxiv.org/abs/2602.05057)
...
### [26] [Learning fermionic linear optics with Heisenberg scaling and physical operations](https://arxiv.org/abs/2602.05058)
...
### [28] [Photonic entanglement enhanced multidimensional spectroscopy for probing exciton correlations: theory and applications to photosynthetic aggregates](https://arxiv.org/abs/2602.05080)
...
### [30] [Quantum computational imaging and sensing](https://arxiv.org/abs/2602.05102)
*Mohan Sarovar*
...
### [31] [Quantum Sequential Circuits](https://arxiv.org/abs/2602.05166)
*D. -S. Wang*
...
### [32] [Broadband Population Transfer Based on Suture Adiabatic Pulses](https://arxiv.org/abs/2602.05199)
...
### [33] [Practical continuous-variable quantum key distribution using dynamic digital signal processing: security proof and experimental demonstration](https://arxiv.org/abs/2602.05206)
...
### [34] [Robust Negativity in the Quantum-to-Classical Transition of Kerr Dynamics](https://arxiv.org/abs/2602.05223)
...
### [35] [Quantum-Inspired Algorithm for Classical Spin Hamiltonians Based on Matrix Product Operators](https://arxiv.org/abs/2602.05224)
...
### [36] [Quantum scattering in helically twisted geometries: Coulomb-like interaction and Aharonov-Bohm effect](https://arxiv.org/abs/2602.05229)
...
### [37] [Gradient Analysis of Barren Plateau in Parameterized Quantum Circuits with multi-qubit gates](https://arxiv.org/abs/2602.05288)
...
### [38] [Entanglement-enhanced quantum metrology via alternating in-phase and quadrature modulation](https://arxiv.org/abs/2602.05337)
...
### [39] [High-order dynamical decoupling in the weak-coupling regime](https://arxiv.org/abs/2602.05343)
...
### [40] [Matchgate synthesis via Clifford matchgates and $T$ gates](https://arxiv.org/abs/2602.05425)
...
### [41] [Quantum-Enhanced Deterministic Inference of $k$-Independent Set Instances on Neutral Atom Arrays](https://arxiv.org/abs/2602.05432)
...
### [42] [Bell and EPR experiments with signalling data](https://arxiv.org/abs/2602.05507)
...
### [43] [Single shot distinguishability of noisy quantum channels](https://arxiv.org/abs/2602.05521)
*Satyaki Manna*
...
### [44] [Arithmetic Reconciliation for CVQKD: Challenges and Feasibility](https://arxiv.org/abs/2602.05526)
...
### [45] [Reducing the Complexity of Matrix Multiplication to $O(N^2log_2N)$ by an Asymptotically Optimal Quantum Algorithm](https://arxiv.org/abs/2602.05541)
*Jiaqi Yao,Ding Liu*
...
### [46] [Simulation of boson sampling with optical feedback](https://arxiv.org/abs/2602.05566)
...
### [47] [Adaptive controllable architecture of analog Ising machine](https://arxiv.org/abs/2602.05595)
...
### [48] [Simultaneous reconstruction of quantum process and noise via corrupted sensing](https://arxiv.org/abs/2602.05604)
...
### [49] [Hamiltonian Benchmark of a Solid-State Spin-Photon Interface for Computation](https://arxiv.org/abs/2602.05637)
...
### [50] [Investigations on Quantum Correlations and Open Quantum System Dynamics Through Nuclear Spins](https://arxiv.org/abs/2602.05661)
*Arijit Chatterjee*
...
### [51] [Numerical approaches to entangling dynamics from variational principles](https://arxiv.org/abs/2602.05726)
...
### [52] [Efficient implementation of arbitrary Hermitian-preserving and trace-preserving maps](https://arxiv.org/abs/2602.05777)
...
### [53] [Advanced Quantum Communication and Quantum Networks -- From basic research to future applications](https://arxiv.org/abs/2602.05781)
...
### [54] [The Quantum Message Complexity of Distributed Wake-Up with Advice](https://arxiv.org/abs/2602.05801)
...
### [55] [Assessing the Sensitivity of Niobium- and Tantalum-Based Superconducting Qubits to Infrared Radiation](https://arxiv.org/abs/2602.05806)
...
### [56] [Simulation of Adjoints and Petz Recovery Maps for Unknown Quantum Channels](https://arxiv.org/abs/2602.05828)
...
### [57] [Entropy Bounds via Hypothesis Testing and Its Applications to Two-Way Key Distillation in Quantum Cryptography](https://arxiv.org/abs/2602.05870)
...
### [58] [Thermal-Drift Sampling: Generating Random Thermal Ensembles for Quantum Chaos Diagnostics](https://arxiv.org/abs/2602.05912)
...
### [59] [Quantum Error Mitigation at the pre-processing stage](https://arxiv.org/abs/2602.05916)
...
### [60] [Quantum Approximate Optimization of Integer Graph Problems and Surpassing Semidefinite Programming for Max-k-Cut](https://arxiv.org/abs/2602.05956)
...
### [61] [One-Way Quantum Secure Direct Communication with Choice of Measurement Basis as the Secret](https://arxiv.org/abs/2602.05972)
...
### [62] [Improved Rodeo Algorithm Performance for Spectral Functions and State Preparation](https://arxiv.org/abs/2602.05978)
...
### [63] [Improving Ground State Accuracy of Variational Quantum Eigensolvers with Soft-coded Orthogonal Subspace Representations](https://arxiv.org/abs/2602.05980)
...
### [64] [Quantum noise scaling in continuously operating multiparameter sensors](https://arxiv.org/abs/2602.05991)
...
### [65] [Modeling integrated frequency shifters and beam splitters](https://arxiv.org/abs/2602.06003)
...
### [66] [Constraints on stability and renormalization group flows in nonequilibrium matter](https://arxiv.org/abs/2602.04961)
...
### [67] [Instability of G/M/c queues under stochastic resetting in the interval](https://arxiv.org/abs/2602.05009)
...
### [68] [Mean-field behavior of the finite size Ising model near its critical point](https://arxiv.org/abs/2602.05212)
...
### [69] [Exchange Monte Carlo for continuous-space Path Integral Monte Carlo simulation](https://arxiv.org/abs/2602.05500)
*Xun Zhao,Synge Todo*
...
### [70] [A Novel Mechanism of Ordering in a Coupled Driven System: Vacancy Induced Phase Separation](https://arxiv.org/abs/2602.05537)
...
### [71] [Graph--Theoretic Analysis of Phase Optimization Complexity in Variational Wave Functions for Heisenberg Antiferromagnets](https://arxiv.org/abs/2602.04943)
...
### [72] [Incommensurate pair-density-wave correlations in two-leg ladder $t$--$J$--$J_\perp$ model](https://arxiv.org/abs/2602.04945)
...
### [81] [Giant bubbles of Fisher zeros in the quantum XY chain](https://arxiv.org/abs/2602.05899)
...
### [82] [Reducing the Computational Cost Scaling of Tensor Network Algorithms via Field-Programmable Gate Array Parallelism](https://arxiv.org/abs/2602.05900)
...
### [83] [Spontaneous Parity Breaking in Quantum Antiferromagnets on the Triangular Lattice](https://arxiv.org/abs/2602.05901)
