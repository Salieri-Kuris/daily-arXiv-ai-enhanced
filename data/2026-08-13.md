...
### [7] [Exchange Fluctuation Theorems for Non-Markovian Baths in Quantum Collisional Model](https://arxiv.org/abs/2608.11488)
...
### [8] [Benchmarking Quantum and Classical Machine Learning Models on Oncological Data](https://arxiv.org/abs/2608.11373)
...
### [9] [Enhancing the power of a quantum heat engine via control of the system--reservoir coupling](https://arxiv.org/abs/2608.12055)
...
### [11] [Conditional dependence and Scrooge ensembles in shallow random quantum circuits](https://arxiv.org/abs/2608.12255)
...
### [17] [Hamilton-Zero: A Neural Tensor-Network Foundation Model for Ground States of Arbitrary Quadratic Qubit Hamiltonians](https://arxiv.org/abs/2608.11911)
...
### [40] [Design of monolithic microcavities for enhancing organic quantum emitters](https://arxiv.org/abs/2608.12081)
...
### [41] [The Min-Rains Relative Entropy Is Not Tight for Exact PPT Entanglement Distillation](https://arxiv.org/abs/2608.12135)
...
### [42] [Floquet-Resolved Dissipation Selects Entanglement Beyond Population Spectroscopy](https://arxiv.org/abs/2608.12178)
...
### [43] [Parity Mapping for Quantum Optimization on Frustrated Ising Rings](https://arxiv.org/abs/2608.12213)
...
### [44] [Capability-Adaptive Cryptanalysis with Reduced-Space Quantum Verification](https://arxiv.org/abs/2608.12234)
...
### [45] [Isospectral majorization and isoperimetric inequalities for coherent states on the Bloch sphere](https://arxiv.org/abs/2608.12248)
*Luis Daniel Abreu*
...
### [49] [Discriminating superconducting fluctuations from the pseudogap in Bi$_2$Sr$_2$Ca$_{n-1}$Cu$_n$O$_{2n+4+δ} (n = 2,3)$: A magnetotransport study](https://arxiv.org/abs/2608.11284)
...
### [50] [Light induced superconducting diode effect in patterned films](https://arxiv.org/abs/2608.11331)
...
### [51] [Yttrium Superhydrides Revisited: Advanced Experimental and Theoretical Studies of YH$_6$, YH$_9$ and YH$_{10}$](https://arxiv.org/abs/2608.11428)
...
### [52] [Acoustic Plasmon Resonance: Breaking the Anderson Stiffness Paradigm in Quasi-Two-Dimensional Superconducting Films](https://arxiv.org/abs/2608.11610)
...
### [53] [Thickness-Driven Superconductor-Insulator Transition in (Cu,C)-1234 and Proximity-Induced Superconductivity Recovery in (Cu,C)-1234/YBCO Heterostructure](https://arxiv.org/abs/2608.11707)
...
### [54] [Spin-polarized supercurrents and Josephson diode effect in altermagnets](https://arxiv.org/abs/2608.11906)
...
### [55] [Large bias-tunable magnetoresistance from spin-dependent interlayer hybridization in van der Waals antiferromagnet CrSBr-based heterostructures](https://arxiv.org/abs/2608.11389)
...
### [56] [Layer-Number-Controlled Symmetry Breaking and Surface-State Transport in Rhombohedral Graphene Multilayers](https://arxiv.org/abs/2608.11450)
...
### [57] [Dynamics of the spontaneous emission factor in multiple quantum well nanowire lasers](https://arxiv.org/abs/2608.11523)
...
### [58] [Spatially Resolving the Pre-Thermal Anatomy of a Driven Bosonic Fluid](https://arxiv.org/abs/2608.11561)
...
### [59] [Realization of Arbitrary Gauge Fields via Symmetry-Protected Zero Modes](https://arxiv.org/abs/2608.11609)
...
### [60] [Spin lifetime anisotropy in graphene induced by the SiO2 interface](https://arxiv.org/abs/2608.11615)
...
### [61] [Magnetic noise of a dark exciton Bose-Einstein condensate](https://arxiv.org/abs/2608.11740)
*Pieter M. Gunnink*
...
### [62] [Quantum Anomalous Hall Effect in $d^{10}$ Oxide Monolayers](https://arxiv.org/abs/2608.11855)
...
### [63] [Dimensional crossover and local strain induced deflection of the spin spiral state in multiferroic NiI2](https://arxiv.org/abs/2608.11944)
...
### [64] [Mismatch between Raman shear modes and ferroelectric polarization in 3R-MoS$_{2}$](https://arxiv.org/abs/2608.11988)
...
### [65] [Lectures on ultrathin film ferromagnetism](https://arxiv.org/abs/2608.12189)
*D. Pescia*
...
### [66] [Electron transport in a 1.6~nm-thick double-gated (100) silicon nanosheet: A theoretical study accounting for phonon confinement and remote-phonon scattering](https://arxiv.org/abs/2608.12214)
...
### [67] [Second-Chern Bounds in Non-Abelian Quantum Geometry](https://arxiv.org/abs/2608.12221)
...
### [68] [Exact solution for stationary states of a closed memristor with mobile charged vacancies](https://arxiv.org/abs/2608.12264)
...
### [69] [Wormhole Geometry from a Magnetic Vortex](https://arxiv.org/abs/2608.12285)
...
### [70] [Geometry of Noisy Quantum Many-Body Dynamics with Continuous Symmetries: Entanglement and Correlations](https://arxiv.org/abs/2608.11297)
...
### [71] [Operational identifiability of false-vacuum decay rates in the quantum Ising chain](https://arxiv.org/abs/2608.11339)
...
### [72] [A piston-like polymer stochastic heat engine](https://arxiv.org/abs/2608.11507)
...
### [73] [Ideal heat engine cycles at maximal efficiency -- the ideal gas and beyond](https://arxiv.org/abs/2608.11966)
...
### [74] [Macroscopic fluctuation theory for the multi-time statistics of current in non-stationary diffusive systems](https://arxiv.org/abs/2608.12119)
...
### [75] [Shortcuts to Parameter Sweeps](https://arxiv.org/abs/2608.12154)
...
### [76] [Finite-depth scaling and an exact Bernoulli-leaf identity for the min-plus process on the binary tree](https://arxiv.org/abs/2608.12295)
...
### [77] [Interface phases and dynamics in two-dimensional quantum magnets: A "holographic" approach from universality to quantum simulation](https://arxiv.org/abs/2608.12312)
...
### [78] [Quetzalcoatlite as a Disorder-Free Platform for Chiral Magnetism and Frustration](https://arxiv.org/abs/2608.11301)
...
### [79] [The Fate of Crystalline Topological Phenomena in the Continuum](https://arxiv.org/abs/2608.11302)
...
### [80] [Thermodynamic Spectroscopy of Emergent Excitations in Quantum Spin Ice](https://arxiv.org/abs/2608.11305)
...
### [81] [Light-induced effective magnetic fields in Landau quantized graphene](https://arxiv.org/abs/2608.11751)
...
### [82] [Spin nematic liquid crystal and scalar spin chirality in tetragonal lattice YbMnBi$_2$](https://arxiv.org/abs/2608.11776)
...
### [83] [Phonon anomalies and critical scaling in the spin-$1/2$ trimer chain Na$_2$Cu$_3$Ge$_4$O$_{12}$](https://arxiv.org/abs/2608.12061)
...
### [84] [Two routes to quantum anomalous Hall states in altermagnets](https://arxiv.org/abs/2608.12124)
...
### [85] [Connecting the tensor-categorical formulation of anyon condensation with operator algebras and entropic order parameters](https://arxiv.org/abs/2608.12157)
*Hua-Chen Zhang*
...
### [86] [Proliferation Transitions for Non-Abelian Anyons](https://arxiv.org/abs/2608.12303)
...
### [87] [Probing Impurity Quantum Criticality with Entanglement Witnesses](https://arxiv.org/abs/2608.12317)
...
### [88] [Emergent heavy fermion and superconductivity near Mott transition in twisted bilayer graphene](https://arxiv.org/abs/2608.12319)
*Ya-Hui Zhang*
...
### [89] [Emergent gauge flux and spin ordering in magnetized triangular spin liquids: Applications to Hofstadter-Hubbard model](https://arxiv.org/abs/2601.12898)
