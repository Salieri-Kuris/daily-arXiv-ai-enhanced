...
### [5] [Fermion parity of an Andreev molecule probed by nonlocal Josephson effect](https://arxiv.org/abs/2607.15786)
...
### [6] [Strong intervalley mixing between copropagating quantum Hall edge channels in a silicon MOSFET](https://arxiv.org/abs/2607.15675)
...
### [7] [Drift-Induced Nonreciprocal Hyperbolic Polaritons in Graphene/$α$-MoO$_3$ Heterostructures](https://arxiv.org/abs/2607.15722)
...
### [16] [Fragmented ETH: Prethermalization, Timescales, and Ensemble Inequivalence](https://arxiv.org/abs/2607.15350)
...
### [17] [Scaling regimes of the Kuramoto-Sivashinsky equation from the functional renormalization group](https://arxiv.org/abs/2607.15784)
...
### [18] [Ultrametric organization of energy landscapes on random Erdős--Rényi graphs: topological origin of barrier hierarchy](https://arxiv.org/abs/2607.15902)
*A. P. Zubarev*
...
### [19] [Zigzag ordering, defects, and anomalous relaxation in antiferromagnetic Kuramoto lattices](https://arxiv.org/abs/2607.15911)
...
### [20] [Nonequilibrium thermodynamics of feedback-control: a phase-space perspective](https://arxiv.org/abs/2607.16186)
...
### [21] [Shielded RL for Route-Charged Parity-Term Ordering in QEDA Phase Components](https://arxiv.org/abs/2607.15307)
...
### [22] [Structure-Agnostic Unitary Learning from Quantum Observable Dynamics with Application to Hamiltonian Identification](https://arxiv.org/abs/2607.15316)
*Mohamed Berkani*
...
### [23] [Fate of dynamical quantum phase transitions from sudden quench to slow quench limit](https://arxiv.org/abs/2607.15649)
...
### [24] [Collective Enhancement of Nuclear Excitation for a Nuclear Quantum Battery](https://arxiv.org/abs/2607.15319)
...
### [25] [Quantum error-correcting codes from aperiodic monotiles: the Hat and the Spectre](https://arxiv.org/abs/2607.15326)
...
### [26] [Non-Hermitian Quantum Adiabatic Algorithm](https://arxiv.org/abs/2607.15343)
*Zi-Bo Jin,Yi Zhang*
...
### [27] [Causality from the spectrum: Emergence of causal order from process-matrix mereology](https://arxiv.org/abs/2607.15345)
...
### [28] [The Paradox of the Third Particle is classical](https://arxiv.org/abs/2607.15351)
...
### [29] [Spectral amplification for ground-state energy estimation of electronic structure in first quantization](https://arxiv.org/abs/2607.15358)
...
### [30] [The Trinity of Markovian Quantum Thermodynamics: Unifying the Axiomatic, Microscopic, and Operational Paradigms](https://arxiv.org/abs/2607.15376)
...
### [31] [Saturating the Bayesian Nagaoka-Hayashi bound within numerical precision for the depolarization SU(2) rotation channel](https://arxiv.org/abs/2607.15398)
...
### [32] [Conditional Euclidean-Hamiltonian reductions for sign-problem toy models](https://arxiv.org/abs/2607.15950)
*Tsogtgerel Gantumur*
...
### [33] [Boosting State Discrimination in Quantum Brownian Motion Channel via Memory-Induced Coherence Preservation](https://arxiv.org/abs/2607.15405)
...
### [34] [Quantum-classical crossover in fault-tolerant quantum dynamics simulation](https://arxiv.org/abs/2607.16116)
...
### [35] [Performance Model for Hybrid Quantum-Classical Workflows](https://arxiv.org/abs/2607.15426)
...
### [36] [Generation and detection of squeezed light on a single silicon photonic chip](https://arxiv.org/abs/2607.15461)
...
### [37] [Efficient routing and spectrum allocation in arbitrary flex-grid entanglement networks](https://arxiv.org/abs/2607.15465)
...
### [38] [The Complexity of Dynamical Correlators: Operator Shadows and Exponential Learning Separations](https://arxiv.org/abs/2607.15493)
...
### [39] [Microscopic Side Information Controls Ordered Hayden--Preskill Recovery](https://arxiv.org/abs/2607.15537)
...
### [40] [Benchmarking Hybrid Quantum-Classical Algorithms for Power Grid Optimization Problems](https://arxiv.org/abs/2607.15543)
...
### [41] [Reconstruction of the noise correlation spectral density from the cavity emission in a two-qubit system](https://arxiv.org/abs/2607.15909)
...
### [42] [Quantum states supported by matroids](https://arxiv.org/abs/2607.15548)
...
### [43] [Agnostic learning of qudit stabilizer states](https://arxiv.org/abs/2607.15559)
...
### [44] [Deterministic atom-shuttle interconnects via ultrafast atom-ion entangling gate](https://arxiv.org/abs/2607.15597)
*Mu Qiao*
...
### [45] [Classical codes violate the conjectured square-root bound for quantum random access codes](https://arxiv.org/abs/2607.15617)
*Kangqiao Liu*
...
### [46] [Spectral Attack on Continuous-Variable Quantum Key Distribution Systems](https://arxiv.org/abs/2607.15668)
...
### [47] [Boundary-Phase Control of Sequentially Addressed Trapped-Ion ZZ Interactions](https://arxiv.org/abs/2607.15688)
...
### [48] [Non-Gaussianity in cat codes: global incompatibility and local geometric alignment with the magic resource](https://arxiv.org/abs/2607.15739)
...
### [49] [Grover's algorithm for image edge detection](https://arxiv.org/abs/2607.15744)
...
### [50] [Manipulating non-intrinsic outputs of a non-Hermitian coupled system by weak external driving](https://arxiv.org/abs/2607.15770)
...
### [51] [The Fourier Wall: Why Public Tabular Datasets Refuse Quantum Advantage, and a Certified Recipe for Where It Lives](https://arxiv.org/abs/2607.15815)
...
### [52] [Maximal quantum leakage: operational interpretation and quantum channel analysis](https://arxiv.org/abs/2607.15853)
...
### [53] [The statistical disturbance bound of quantum measurements](https://arxiv.org/abs/2607.15874)
...
### [54] [Alleviating the Sparse Matrix Scaling Bottleneck in Adaptive VQE via Greedy Operator Commutativity Partitioning and High-Order Taylor State Evolution](https://arxiv.org/abs/2607.15906)
...
### [55] [Optimization of multistate STIRAP by pulse shaping](https://arxiv.org/abs/2607.15915)
...
### [56] [Beyond the Positive Partial Transpose Squared Conjecture: The Qutrit Case](https://arxiv.org/abs/2607.15947)
...
### [57] [Parameter Estimation in a Continuously Monitored Non-Markovian Quantum System](https://arxiv.org/abs/2607.15978)
...
### [58] [Tunable Families of Multiqubit Elegant Joint Measurements](https://arxiv.org/abs/2607.16020)
...
### [59] [Quantum Mechanics on Lie Groups: II. Path Integrals](https://arxiv.org/abs/2607.16029)
...
### [60] [Rethinking Quantum Continual Learning with Quantum Fisher Information](https://arxiv.org/abs/2607.16030)
...
### [61] [Rigorous Time-dependent Hamiltonian Learning via Continuous Weak Measurements](https://arxiv.org/abs/2607.16047)
...
### [62] [Operator Entanglement in Quantum Dynamics Simulations: Formalism and Analysis Tools](https://arxiv.org/abs/2607.16070)
...
### [63] [Object-relative ultraviolet weighting of electromagnetic modes and one-loop ultraviolet finiteness in quantum electrodynamics](https://arxiv.org/abs/2607.16096)
*Christian Rembe*
...
### [64] [Parameterized Quantum Circuit Semantics Through Enriched Categories](https://arxiv.org/abs/2607.16114)
...
### [65] [Reverse engineering of single-qubit quantum gates](https://arxiv.org/abs/2607.16124)
...
### [66] [Fast logical operations in quantum LDPC codes using simple resource states](https://arxiv.org/abs/2607.16166)
...
### [67] [Field-induced first order transitions and phase coexistence in the Kitaev quantum spin liquid candidate BaCo2(AsO4)2](https://arxiv.org/abs/2607.15346)
...
### [68] [Data-efficient reconstruction of critical quantum dynamics via blind fractional-envelope extrapolation](https://arxiv.org/abs/2607.15458)
...
### [69] [Topology and compact molecular orbitals in twisted bilayer WSe$_2$](https://arxiv.org/abs/2607.15611)
...
### [70] [Machine-learning test of the single-ion model for $dd$ excitations in cuprates](https://arxiv.org/abs/2607.15763)
...
### [71] [Thermal Order by Disorder in Resonating-Valence Bond States on the Checkerboard Lattice](https://arxiv.org/abs/2607.15813)
...
### [72] [Altermagnetism without a long-range order](https://arxiv.org/abs/2607.15954)
...
### [73] [Deconfined quantum critical point in a dissipative spin-1/2 chain](https://arxiv.org/abs/2607.16039)
...
### [74] [Quantum Fisher information of magnetic quantum phase transition on Kondo lattice](https://arxiv.org/abs/2607.16150)
...
### [75] [First-Order Topological FFLO Transition and Superconducting Diode Sign Reversal in Altermagnetic Nanowires](https://arxiv.org/abs/2607.15720)
...
### [76] [Contactless terahertz mapping of wafer-scale superconducting NbTiN thin films](https://arxiv.org/abs/2607.15757)
...
### [77] [Drosophila of phonon-mediated superconductivity: Full Eliashberg theory of the jellium model](https://arxiv.org/abs/2607.15996)
...
### [78] [Coherent driving of displacive Higgs fluctuations in superconductors](https://arxiv.org/abs/2607.16055)
